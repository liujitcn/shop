...
/** 时间范围选项使用 proto v1 生成枚举成员，避免依赖旧版短成员名。 */
const options = [
  { label: "本周", value: AnalyticsTimeType.ANALYTICS_TIME_TYPE_WEEK },
  { label: "本月", value: AnalyticsTimeType.ANALYTICS_TIME_TYPE_MONTH },
  { label: "本年", value: AnalyticsTimeType.ANALYTICS_TIME_TYPE_YEAR }
];
