...
import { defGoodsReportService } from "@/api/shop/goods_report";
import { defTenantStoreService } from "@/api/shop/tenant_store";
import type { GoodsMonthReportItem, SummaryGoodsMonthReportResponse } from "@/rpc/shop/admin/v1/goods_report";
...
async function loadData() {
  ...
  try {
    ...
    report.items = listData.goods_month_reports ?? [];
  } catch (error) {
