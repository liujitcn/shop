...
import { defGoodsSkuService } from "@/api/shop/admin/goods_sku";
import { defGoodsSpecService } from "@/api/shop/admin/goods_spec";
import type { GoodsSku, PageGoodsSkuRequest } from "@/rpc/shop/admin/v1/goods_sku";
import type { GoodsSpec } from "@/rpc/shop/admin/v1/goods_spec";
