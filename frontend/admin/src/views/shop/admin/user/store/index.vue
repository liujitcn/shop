      ...
      <el-card shadow="never">
        ...
        <el-descriptions border :column="2">
          ...
          <el-descriptions-item label="营业执照">
            <div class="demo-image__preview">
              <el-image
                v-for="(img, index) in detail.business_license"
                :key="index"
                style="width: 100px; height: 100px"
                :src="img"
...
import { defUserStoreService } from "@/api/shop/admin/user_store";
import type { AuditUserStoreRequest, PageUserStoreRequest, UserStore } from "@/rpc/shop/admin/v1/user_store";
...
const formData = reactive<AuditUserStoreRequest>({
  /** 用户门店ID */
  id: 0,
  /** 状态 */
  status: UserStoreStatus.UNKNOWN_USS,
...
const columns: ColumnProps[] = [
  ...
  { prop: "nick_name", label: "联系人", minWidth: 100 },
...
function handleOpenDialog(storeId?: number) {
  ...
  defUserStoreService.GetUserStore({ id: storeId }).then(data => {
    detail.value = data;
    formData.id = data.id;
