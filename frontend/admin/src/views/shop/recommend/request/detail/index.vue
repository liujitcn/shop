...
import RecommendProviderLabel from "@/views/shop/recommend/request/components/ProviderLabel.vue";
import RecommendRequestEventDialog from "@/views/shop/recommend/request/detail/components/EventDialog.vue";
import { defRecommendRequestService } from "@/api/shop/recommend_request";
import type {
...
function handleOpenGoodsDetail(item: RecommendRequestItem) {
  ...
  void navigateTo(router, `/goods/info/detail/${item.goods_id}`);
}
