...
import type { CodeGenProto, CodeGenProtoCheck, CodeGenProtoConfig } from "@/rpc/admin/v1/code_gen_proto";
import type { CodeGenDatabaseTable, CodeGenTableForm } from "@/rpc/admin/v1/code_gen_table";
