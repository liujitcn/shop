...
| 推荐 | 推荐请求、事件、Gorse 调试、编排、配置 | 推荐商品、匿名 ID、事件上报 | 详见 [推荐系统设计](推荐系统设计.md)。 |
| 评价 | 评论、讨论、标签、评价摘要审核 | 评论列表、写评价、互动、评价摘要 | 详见 [评价与审核数据流转设计](评价与审核数据流转设计.md)。 |
...
| `CommentAuditRetry` | 补偿重新投递评价和讨论的异常自动审核队列。 |
