...
require (
	...
	github.com/liujitcn/kratos-kit/auth/authz v0.0.7
	github.com/liujitcn/kratos-kit/auth/authz/engine/casbin v0.0.7
...
require (
	...
	github.com/liujitcn/kratos-kit/logger v0.0.11 // indirect
