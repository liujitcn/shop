...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	recommendGoodsStatDay := task.NewRecommendGoodsStatDay(transaction, recommendGoodsStatDayRepo, recommendRequestRepo, recommendExposureRepo, recommendGoodsActionRepo, orderGoodsRepo)
