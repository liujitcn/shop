...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	v := task.NewTaskList(tradeBill, orderStatDay, goodsStatDay, recommendGoodsStatDay)
	...
	recommendRequestItemCase := biz4.NewRecommendRequestItemCase(baseCase, recommendRequestItemRepo, recommendRequestRepo)
	recommendExposureItemCase := biz4.NewRecommendExposureItemCase(baseCase, recommendExposureItemRepo, recommendExposureRepo, recommendRequestItemCase)
	recommendExposureCase := biz4.NewRecommendExposureCase(baseCase, recommendExposureRepo, recommendExposureItemCase, recommendGoodsActionRepo)
	...
	recommendRequestCase := biz4.NewRecommendRequestCase(baseCase, recommendRequestRepo, recommendRequestItemCase, bizGoodsInfoCase, bizOrderGoodsCase, userCartCase, recommendExposureCase, recommendUserGoodsPreferenceCase, recommendUserPreferenceCase, recommendGoodsRelationCase, recommendGoodsStatDayCase, goodsStatDayCase)
	recommendGoodsActionCase := biz4.NewRecommendGoodsActionCase(baseCase, transaction, recommendGoodsActionRepo, recommendRequestItemCase, recommendUserPreferenceCase, recommendUserGoodsPreferenceCase, recommendGoodsRelationCase, bizGoodsInfoCase)
