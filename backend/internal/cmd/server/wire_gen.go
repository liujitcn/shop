...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	recommendUserPreferenceCase := biz2.NewRecommendUserPreferenceCase(baseCase, recommendUserPreferenceRepo, recommendGoodsActionRepo, goodsInfoRepo)
	...
	recommendGoodsRelationCase := biz2.NewRecommendGoodsRelationCase(baseCase, recommendGoodsRelationRepo, recommendGoodsActionRepo, recommendRequestRepo, recommendRequestItemRepo)
	...
	v := task.NewTaskList(tradeBill, orderStatDay, goodsStatDay, recommendGoodsStatDay, recommendUserPreferenceRebuild, recommendGoodsRelationRebuild)
	...
	goodsPropCase := biz3.NewGoodsPropCase(baseCase, goodsPropRepo)
	goodsSpecRepo := data.NewGoodsSpecRepo(dataData)
	goodsSpecCase := biz3.NewGoodsSpecCase(baseCase, goodsSpecRepo)
	goodsSkuRepo := data.NewGoodsSkuRepo(dataData)
	goodsSkuCase := biz3.NewGoodsSkuCase(baseCase, goodsSkuRepo)
	goodsInfoCase := biz3.NewGoodsInfoCase(baseCase, transaction, goodsInfoRepo, goodsCategoryCase, goodsPropCase, goodsSpecCase, goodsSkuCase)
	orderGoodsCase := biz3.NewOrderGoodsCase(baseCase, orderGoodsRepo)
	goodsAnalyticsCase := biz3.NewGoodsAnalyticsCase(goodsInfoCase, goodsCategoryCase, orderGoodsCase)
	...
	workspaceCase := biz3.NewWorkspaceCase(orderInfoCase, baseUserCase, orderGoodsCase, goodsInfoCase, goodsSkuCase, payBillCase)
	...
	bizGoodsPropCase := biz2.NewGoodsPropCase(baseCase, goodsPropRepo)
	bizGoodsSpecCase := biz2.NewGoodsSpecCase(baseCase, goodsSpecRepo)
	bizGoodsSkuCase := biz2.NewGoodsSkuCase(baseCase, goodsSkuRepo)
	bizGoodsInfoCase := biz2.NewGoodsInfoCase(baseCase, goodsInfoRepo, goodsCategoryRepo, bizGoodsPropCase, bizGoodsSpecCase, bizGoodsSkuCase)
	...
	bizOrderGoodsCase := biz2.NewOrderGoodsCase(baseCase, orderGoodsRepo, bizGoodsInfoCase, bizGoodsSkuCase)
	...
	userCartCase := biz2.NewUserCartCase(baseCase, userCartRepo, bizGoodsInfoCase, bizGoodsSkuCase)
	...
	userCollectCase := biz2.NewUserCollectCase(baseCase, userCollectRepo, bizGoodsInfoCase, bizGoodsSkuCase)
