...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	goodsInfoCase := biz2.NewGoodsInfoCase(baseCase, goodsInfoRepository, goodsCategoryRepository, goodsPropCase, goodsSpecCase, goodsSKUCase)
	...
	commentAuditRetry := task.NewCommentAuditRetry(commentInfoRepository, commentDiscussionRepository, commentReviewRepository, commentCase)
	...
	bizCasbinRuleCase, err := biz3.NewCasbinRuleCase(baseCase, casbinRuleRepository, baseMenuRepository, baseRoleRepository, bizBaseAPICase, engine)
	if err != nil {
		cleanup4()
		cleanup3()
		cleanup2()
	...
	baseRoleCase := biz3.NewBaseRoleCase(baseCase, transaction, baseRoleRepository, bizCasbinRuleCase)
	...
	authCase := biz3.NewAuthCase(baseCase, bizBaseUserCase, baseRoleCase, baseDeptCase, baseMenuCase, fileCase)
	...
	goodsCategoryCase := biz3.NewGoodsCategoryCase(baseCase, goodsCategoryRepository)
	...
	bizGoodsInfoCase := biz3.NewGoodsInfoCase(baseCase, transaction, goodsInfoRepository, goodsCategoryCase, bizGoodsPropCase, bizGoodsSpecCase, bizGoodsSKUCase)
	goodsAnalyticsCase := biz3.NewGoodsAnalyticsCase(bizGoodsInfoCase, goodsCategoryCase, goodsStatDayRepository)
	...
	bizGoodsCategoryCase := biz2.NewGoodsCategoryCase(baseCase, goodsCategoryRepository, goodsInfoRepository)
	...
	bizShopBannerCase := biz2.NewShopBannerCase(baseCase, shopBannerRepository, bizGoodsCategoryCase)
