...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	commentSummaryCase := biz2.NewCommentSummaryCase(baseCase, commentSummaryRepository)
	commentInfoCase := biz2.NewCommentInfoCase(baseCase, commentInfoRepository, transaction, commentTagCase, commentDiscussionCase, commentSummaryCase, commentReviewCase, baseUserCase)
	...
	workspaceCase := biz2.NewWorkspaceCase(orderInfoCase, baseUserCase, orderGoodsCase, goodsInfoCase, goodsSKUCase, payBillCase, commentInfoCase, commentDiscussionCase, commentTagCase, commentSummaryCase)
	...
	bizCommentSummaryCase := biz4.NewCommentSummaryCase(baseCase, commentSummaryRepository, commentReactionRepository)
	...
	commentReactionCase := biz4.NewCommentReactionCase(baseCase, commentReactionRepository, commentInfoRepository, commentSummaryRepository, commentDiscussionRepository)
	...
	commentCase := biz4.NewCommentCase(baseCase, transaction, bizCommentInfoCase, bizCommentSummaryCase, bizCommentTagCase, bizCommentReviewCase, bizCommentDiscussionCase, commentReactionCase, bizOrderInfoCase, bizOrderGoodsCase, bizBaseUserCase, runtime)
	...
	recommendCase := biz4.NewRecommendCase(baseCase, transaction, bizRecommendRequestCase, bizRecommendEventCase, bizOrderGoodsCase, userCartCase, userCollectCase, bizGoodsInfoCase, goodsReceiver)
