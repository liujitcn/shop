...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	bizBaseUserCase := biz3.NewBaseUserCase(baseCase, baseUserRepository, baseDeptRepository, orderInfoRepository, baseRoleCase, baseDeptCase, baseMenuCase)
	baseTenantCase := biz3.NewBaseTenantCase(baseCase, transaction, baseTenantRepository, baseDeptRepository, baseRoleRepository, baseUserRepository, tenantStoreRepository, goodsInfoRepository, orderInfoRepository, commentInfoRepository, casbinRuleRepository, bizCasbinRuleCase)
