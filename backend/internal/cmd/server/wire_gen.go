...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	userCartCase := biz3.NewUserCartCase(baseCase, userCartRepository, goodsInfoCase, goodsSKUCase)
	...
	userCollectCase := biz3.NewUserCollectCase(baseCase, userCollectRepository, goodsInfoCase, goodsSKUCase)
