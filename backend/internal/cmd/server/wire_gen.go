...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	recommendExposureCase := biz4.NewRecommendExposureCase(baseCase, recommendExposureRepo, recommendGoodsActionRepo)
	...
	recommendGoodsActionCase := biz4.NewRecommendGoodsActionCase(baseCase, transaction, recommendGoodsActionRepo, recommendRequestCase, recommendUserPreferenceCase, recommendUserGoodsPreferenceCase, recommendGoodsRelationCase, bizGoodsInfoCase)
