...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	goodsStatDay := task.NewGoodsStatDay(transaction, goodsStatDayRepository, goodsInfoRepository, recommendEventRepository, userCollectRepository, userCartRepository, orderInfoRepository, orderGoodsRepository)
	...
	bizOrderInfoCase := biz2.NewOrderInfoCase(baseCase, transaction, bizOrderAddressCase, orderInfoRepository, bizOrderCancelCase, bizOrderGoodsCase, bizOrderLogisticsCase, bizOrderPaymentCase, bizOrderRefundCase, bizBaseUserCase, bizBaseDictItemCase, wxPayCase)
	...
	recommendCase := biz3.NewRecommendCase(baseCase, transaction, bizRecommendRequestCase, bizRecommendEventCase, orderGoodsCase, userCartCase, userCollectCase, goodsInfoCase, goodsReceiver)
