...
func NewHttpServer(
	...
	adminRecommendRemote *admin.RecommendRemoteService,
	...
	adminApi.RegisterRecommendRequestServiceHTTPServer(srv, adminRecommendRequest)
	adminApi.RegisterRecommendRemoteServiceHTTPServer(srv, adminRecommendRemote)
