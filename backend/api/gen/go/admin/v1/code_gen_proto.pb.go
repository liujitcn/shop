...
func (x *CodeGenProto) Reset() {
	*x = CodeGenProto{}
	mi := &file_admin_v1_code_gen_proto_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CodeGenProto) Descriptor() ([]byte, []int) {
	return file_admin_v1_code_gen_proto_proto_rawDescGZIP(), []int{3}
}
...
func (x *CodeGenProtoCheck) Reset() {
	*x = CodeGenProtoCheck{}
	mi := &file_admin_v1_code_gen_proto_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CodeGenProtoCheck) Descriptor() ([]byte, []int) {
	return file_admin_v1_code_gen_proto_proto_rawDescGZIP(), []int{4}
}
...
func (x *CodeGenProtoConfig) Reset() {
	*x = CodeGenProtoConfig{}
	mi := &file_admin_v1_code_gen_proto_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CodeGenProtoConfig) Descriptor() ([]byte, []int) {
	return file_admin_v1_code_gen_proto_proto_rawDescGZIP(), []int{5}
}
...
var File_admin_v1_code_gen_proto_proto protoreflect.FileDescriptor
...
const file_admin_v1_code_gen_proto_proto_rawDesc = "" +
	...
	"\x15generate_when_missing\x18\b \x01(\bB\x1b\xbaG\x18\x92\x02\x15缺失时是否生成R\x13generateWhenMissing\x12N\n" +
	"\x06config\x18\t \x01(\v2\x1c.admin.v1.CodeGenProtoConfigB\x18\xbaG\x15\x92\x02\x12接口类型配置R\x06config\x12 \n" +
	"\x04sort\x18\n" +
	" \x01(\x05B\f\xbaG\t\x92\x02\x06排序R\x04sort\"\xef\x04\n" +
...
var (
	file_admin_v1_code_gen_proto_proto_rawDescOnce sync.Once
	file_admin_v1_code_gen_proto_proto_rawDescData []byte
)

func file_admin_v1_code_gen_proto_proto_rawDescGZIP() []byte {
	file_admin_v1_code_gen_proto_proto_rawDescOnce.Do(func() {
		file_admin_v1_code_gen_proto_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_admin_v1_code_gen_proto_proto_rawDesc), len(file_admin_v1_code_gen_proto_proto_rawDesc)))
	})
	return file_admin_v1_code_gen_proto_proto_rawDescData
}
...
func init() { file_admin_v1_code_gen_proto_proto_init() }
func file_admin_v1_code_gen_proto_proto_init() {
	if File_admin_v1_code_gen_proto_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_v1_code_gen_proto_proto_rawDesc), len(file_admin_v1_code_gen_proto_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_admin_v1_code_gen_proto_proto_goTypes,
		DependencyIndexes: file_admin_v1_code_gen_proto_proto_depIdxs,
		MessageInfos:      file_admin_v1_code_gen_proto_proto_msgTypes,
	}.Build()
	File_admin_v1_code_gen_proto_proto = out.File
	file_admin_v1_code_gen_proto_proto_goTypes = nil
	file_admin_v1_code_gen_proto_proto_depIdxs = nil
}
