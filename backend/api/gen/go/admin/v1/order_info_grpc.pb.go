...
const (
	...
	OrderInfoService_GetOrderInfoShipment_FullMethodName = "/admin.v1.OrderInfoService/GetOrderInfoShipment"
	OrderInfoService_ShipOrderInfo_FullMethodName        = "/admin.v1.OrderInfoService/ShipOrderInfo"
)
...
func (c *orderInfoServiceClient) GetOrderInfo(ctx context.Context, in *GetOrderInfoRequest, opts ...grpc.CallOption) (*OrderInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *orderInfoServiceClient) GetOrderInfoRefund(ctx context.Context, in *GetOrderInfoRefundRequest, opts ...grpc.CallOption) (*OrderInfoRefundResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func _OrderInfoService_GetOrderInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderInfoServiceServer).GetOrderInfo(ctx, req.(*GetOrderInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrderInfoService_GetOrderInfoRefund_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrderInfoRefundRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderInfoServiceServer).GetOrderInfoRefund(ctx, req.(*GetOrderInfoRefundRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderInfoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "admin.v1.OrderInfoService",
	...
	Metadata: "admin/v1/order_info.proto",
}
