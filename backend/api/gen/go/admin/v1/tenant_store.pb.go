...
type PageTenantStoresRequest struct {
	...
	Status        *v1.TenantStoreStatus  `protobuf:"varint,100,opt,name=status,proto3,enum=common.v1.TenantStoreStatus,oneof" json:"status,omitempty"` // 审核状态：枚举【TenantStoreStatus】
...
func (x *GetTenantStoreRequest) Reset() {
	*x = GetTenantStoreRequest{}
	mi := &file_admin_v1_tenant_store_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetTenantStoreRequest) Descriptor() ([]byte, []int) {
	return file_admin_v1_tenant_store_proto_rawDescGZIP(), []int{6}
}
...
func (x *CreateTenantStoreRequest) Reset() {
	*x = CreateTenantStoreRequest{}
	mi := &file_admin_v1_tenant_store_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateTenantStoreRequest) Descriptor() ([]byte, []int) {
	return file_admin_v1_tenant_store_proto_rawDescGZIP(), []int{7}
}
...
func (x *UpdateTenantStoreRequest) Reset() {
	*x = UpdateTenantStoreRequest{}
	mi := &file_admin_v1_tenant_store_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateTenantStoreRequest) Descriptor() ([]byte, []int) {
	return file_admin_v1_tenant_store_proto_rawDescGZIP(), []int{8}
}
...
func (x *DeleteTenantStoreRequest) Reset() {
	*x = DeleteTenantStoreRequest{}
	mi := &file_admin_v1_tenant_store_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteTenantStoreRequest) Descriptor() ([]byte, []int) {
	return file_admin_v1_tenant_store_proto_rawDescGZIP(), []int{9}
}
...
type AuditTenantStoreRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                           // 门店ID
	Status        v1.TenantStoreStatus   `protobuf:"varint,51,opt,name=status,proto3,enum=common.v1.TenantStoreStatus" json:"status,omitempty"` // 审核状态：枚举【TenantStoreStatus】
...
func (x *AuditTenantStoreRequest) Reset() {
	*x = AuditTenantStoreRequest{}
	mi := &file_admin_v1_tenant_store_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AuditTenantStoreRequest) Descriptor() ([]byte, []int) {
	return file_admin_v1_tenant_store_proto_rawDescGZIP(), []int{10}
}
...
type TenantStore struct {
	...
	Status          v1.TenantStoreStatus   `protobuf:"varint,100,opt,name=status,proto3,enum=common.v1.TenantStoreStatus" json:"status,omitempty"`      // 审核状态：枚举【TenantStoreStatus】
...
func (x *TenantStore) Reset() {
	*x = TenantStore{}
	mi := &file_admin_v1_tenant_store_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TenantStore) Descriptor() ([]byte, []int) {
	return file_admin_v1_tenant_store_proto_rawDescGZIP(), []int{11}
}
...
func (x *TenantStoreForm) Reset() {
	*x = TenantStoreForm{}
	mi := &file_admin_v1_tenant_store_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TenantStoreForm) Descriptor() ([]byte, []int) {
	return file_admin_v1_tenant_store_proto_rawDescGZIP(), []int{12}
}
...
var File_admin_v1_tenant_store_proto protoreflect.FileDescriptor
...
const file_admin_v1_tenant_store_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\x03B\x0e\xbaG\v\x92\x02\b门店IDR\x02id\"r\n" +
	"\x18CreateTenantStoreRequest\x12V\n" +
	"\ftenant_store\x18\x01 \x01(\v2\x19.admin.v1.TenantStoreFormB\x18\xbaG\x15\x92\x02\x12租户门店表单R\vtenantStore\"\x92\x01\n" +
	"\x18UpdateTenantStoreRequest\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\x03B\x0e\xbaG\v\x92\x02\b门店IDR\x02id\x12V\n" +
	"\ftenant_store\x18\x02 \x01(\v2\x19.admin.v1.TenantStoreFormB\x18\xbaG\x15\x92\x02\x12租户门店表单R\vtenantStore\"Z\n" +
	"\x18DeleteTenantStoreRequest\x12>\n" +
	"\x03ids\x18\x01 \x01(\tB,\xbaG)\x92\x02&门店ID列表，多个用逗号分隔R\x03ids\"\xcf\x01\n" +
	"\x17AuditTenantStoreRequest\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\x03B\x0e\xbaG\v\x92\x02\b门店IDR\x02id\x12h\n" +
	"\x06status\x183 \x01(\x0e2\x1c.common.v1.TenantStoreStatusB2\xbaG/\x92\x02,审核状态：枚举【TenantStoreStatus】R\x06status\x12*\n" +
	"\x06remark\x184 \x01(\tB\x12\xbaG\x0f\x92\x02\f审核备注R\x06remark\"\xdf\x04\n" +
	...
	"\x10business_license\x18\t \x03(\tB\x12\xbaG\x0f\x92\x02\f营业执照R\x0fbusinessLicense\x12h\n" +
	"\x06status\x18d \x01(\x0e2\x1c.common.v1.TenantStoreStatusB2\xbaG/\x92\x02,审核状态：枚举【TenantStoreStatus】R\x06status\x12$\n" +
	...
	"\n" +
	"updated_at\x18\xc9\x01 \x01(\tB\x12\xbaG\x0f\x92\x02\f更新时间R\tupdatedAt\"\xde\x03\n" +
	...
	"\x11DeleteTenantStore\x12\".admin.v1.DeleteTenantStoreRequest\x1a\x16.google.protobuf.Empty\"(\x82\xd3\xe4\x93\x02\"* /api/v1/admin/tenant/store/{ids}\x12\x7f\n" +
	"\x10AuditTenantStore\x12!.admin.v1.AuditTenantStoreRequest\x1a\x16.google.protobuf.Empty\"0\x82\xd3\xe4\x93\x02*:\x01*\x1a%/api/v1/admin/tenant/store/{id}/auditB\x83\x01\n" +
	"\fcom.admin.v1B\x10TenantStoreProtoP\x01Z shop/api/gen/go/admin/v1;adminv1\xa2\x02\x03AXX\xaa\x02\bAdmin.V1\xca\x02\bAdmin\\V1\xe2\x02\x14Admin\\V1\\GPBMetadata\xea\x02\tAdmin::V1b\x06proto3"

var (
	file_admin_v1_tenant_store_proto_rawDescOnce sync.Once
	file_admin_v1_tenant_store_proto_rawDescData []byte
)

func file_admin_v1_tenant_store_proto_rawDescGZIP() []byte {
	file_admin_v1_tenant_store_proto_rawDescOnce.Do(func() {
		file_admin_v1_tenant_store_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_admin_v1_tenant_store_proto_rawDesc), len(file_admin_v1_tenant_store_proto_rawDesc)))
	})
	return file_admin_v1_tenant_store_proto_rawDescData
}
...
var file_admin_v1_tenant_store_proto_depIdxs = []int32{
	...
	16, // 24: admin.v1.TenantStoreService.DeleteTenantStore:output_type -> google.protobuf.Empty
	16, // 25: admin.v1.TenantStoreService.AuditTenantStore:output_type -> google.protobuf.Empty
...
func init() { file_admin_v1_tenant_store_proto_init() }
func file_admin_v1_tenant_store_proto_init() {
	if File_admin_v1_tenant_store_proto != nil {
		return
	}
	file_admin_v1_tenant_store_proto_msgTypes[4].OneofWrappers = []any{}
	file_admin_v1_tenant_store_proto_msgTypes[12].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_v1_tenant_store_proto_rawDesc), len(file_admin_v1_tenant_store_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_admin_v1_tenant_store_proto_goTypes,
		DependencyIndexes: file_admin_v1_tenant_store_proto_depIdxs,
		MessageInfos:      file_admin_v1_tenant_store_proto_msgTypes,
	}.Build()
	File_admin_v1_tenant_store_proto = out.File
	file_admin_v1_tenant_store_proto_goTypes = nil
	file_admin_v1_tenant_store_proto_depIdxs = nil
}
