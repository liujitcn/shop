...
const file_system_admin_v1_base_dept_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\x03B\x0e\xbaG\v\x92\x02\b部门IDR\x02id\"\x99\x06\n" +
	...
	"\x1cbase_dept.tenant_id.required\x12\x18所属租户不能为空\x1a\bthis > 0R\btenantId\x12~\n" +
	"\tparent_id\x18\x03 \x01(\x03B\\\xbaG\x11\x92\x02\x0e父级部门ID\xbaHE\xba\x01B\n" +
	"\x1cbase_dept.parent_id.required\x12\x18上级部门不能为空\x1a\bthis > 0H\x00R\bparentId\x88\x01\x01\x12\xc9\x01\n" +
	...
	"\x16base_dept.name.max_len\x12&部门名称不能超过 255 个字符\x1a\x12this.size() <= 255R\x04name\x12]\n" +
	"\x04sort\x18\x05 \x01(\x05BI\xbaG\t\x92\x02\x06排序\xbaH:\xba\x017\n" +
	"\x17base_dept.sort.required\x12\x12排序不能为空\x1a\bthis > 0R\x04sort\x12?\n" +
	...
	"\x11SetBaseDeptStatus\x12).system.admin.v1.SetBaseDeptStatusRequest\x1a\x16.google.protobuf.Empty\".\x82\xd3\xe4\x93\x02(:\x01*\x1a#/api/v1/admin/base/dept/{id}/statusB\xab\x01\n" +
	"\x13com.system.admin.v1B\rBaseDeptProtoP\x01Z'shop/api/gen/go/system/admin/v1;adminv1\xa2\x02\x03SAX\xaa\x02\x0fSystem.Admin.V1\xca\x02\x0fSystem\\Admin\\V1\xe2\x02\x1bSystem\\Admin\\V1\\GPBMetadata\xea\x02\x11System::Admin::V1b\x06proto3"
