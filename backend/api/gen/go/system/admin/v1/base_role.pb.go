...
const file_system_admin_v1_base_role_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\x03B\x0e\xbaG\v\x92\x02\b角色IDR\x02id\"\x96\b\n" +
	...
	"\x1dbase_role.data_scope.required\x12\x15请选择数据权限\x1a\tthis != 0\x82\x01\x02\x10\x01R\tdataScope\x12;\n" +
	"\x05menus\x18\x06 \x03(\x03B%\xbaG\x18\x92\x02\x15分配的菜单列表\xbaH\a\x92\x01\x04\b\x01\x18\x01R\x05menus\x12?\n" +
	...
	"\x02id\x18\x01 \x01(\tB\x14\xbaG\x11\x92\x02\x0e角色ID列表R\x02id\"s\n" +
	"\x16SetBaseRoleMenuRequest\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\x03B\x0e\xbaG\v\x92\x02\b角色IDR\x02id\x129\n" +
	"\x05menus\x18\x02 \x03(\x03B#\xbaG\x18\x92\x02\x15分配的菜单列表\xbaH\x05\x92\x01\x02\b\x01R\x05menus\"`\n" +
