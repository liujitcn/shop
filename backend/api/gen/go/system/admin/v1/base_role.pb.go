...
const file_system_admin_v1_base_role_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\x03B\x0e\xbaG\v\x92\x02\b角色IDR\x02id\"\x9b\t\n" +
	...
	"\x02id\x18\x01 \x01(\tB\x14\xbaG\x11\x92\x02\x0e角色ID列表R\x02id\"\xfa\x01\n" +
	"\x16SetBaseRoleMenuRequest\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\x03B\x0e\xbaG\v\x92\x02\b角色IDR\x02id\x12\xbf\x01\n" +
	"\x05menus\x18\x02 \x03(\x03B\xa8\x01\xbaG\x18\x92\x02\x15分配的菜单列表\xbaH\x89\x01\xba\x01B\n" +
	"\x18base_role.menus.required\x12\x15请选择菜单权限\x1a\x0fthis.size() > 0\xba\x01A\n" +
	"\x16base_role.menus.unique\x12\x18菜单权限不能重复\x1a\rthis.unique()R\x05menus\"`\n" +
