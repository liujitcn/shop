...
const OperationPayServiceH5Pay = "/app.PayService/H5Pay"
const OperationPayServiceJsapiPay = "/app.PayService/JsapiPay"
const OperationPayServicePayNotify = "/app.PayService/PayNotify"
...
func RegisterPayServiceHTTPServer(s *http.Server, srv PayServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/api/app/pay/{orderId}/jsapi", _PayService_JsapiPay0_HTTP_Handler(srv))
	r.POST("/api/app/pay/{orderId}/h5", _PayService_H5Pay0_HTTP_Handler(srv))
	r.POST("/api/app/pay/notify", _PayService_PayNotify0_HTTP_Handler(srv))
}
