...
func RegisterAuthServiceHTTPServer(s *http.Server, srv AuthServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/api/v1/app/auth/wechat", _AuthService_WechatLogin0_HTTP_Handler(srv))
	r.GET("/api/v1/app/auth/profile", _AuthService_GetUserProfile0_HTTP_Handler(srv))
	r.PUT("/api/v1/app/auth/profile", _AuthService_UpdateUserProfile0_HTTP_Handler(srv))
	r.PUT("/api/v1/app/auth/phone", _AuthService_BindUserPhone0_HTTP_Handler(srv))
}
