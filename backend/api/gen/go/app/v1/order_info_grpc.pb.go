...
const (
	OrderInfoService_ConfirmOrderInfo_FullMethodName        = "/app.v1.OrderInfoService/ConfirmOrderInfo"
	OrderInfoService_BuyNowOrderInfo_FullMethodName         = "/app.v1.OrderInfoService/BuyNowOrderInfo"
	OrderInfoService_RepurchaseOrderInfo_FullMethodName     = "/app.v1.OrderInfoService/RepurchaseOrderInfo"
	OrderInfoService_CountOrderInfo_FullMethodName          = "/app.v1.OrderInfoService/CountOrderInfo"
...
func (c *orderInfoServiceClient) DeleteOrderInfo(ctx context.Context, in *DeleteOrderInfoRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
var OrderInfoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "app.v1.OrderInfoService",
	...
	Metadata: "app/v1/order_info.proto",
}
