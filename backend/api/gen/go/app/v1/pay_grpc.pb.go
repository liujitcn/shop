...
const (
	PayService_JsapiPay_FullMethodName  = "/app.v1.PayService/JsapiPay"
	PayService_H5Pay_FullMethodName     = "/app.v1.PayService/H5Pay"
	PayService_PayNotify_FullMethodName = "/app.v1.PayService/PayNotify"
)
