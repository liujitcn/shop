...
const (
	PayService_JsapiPay_FullMethodName  = "/app.PayService/JsapiPay"
	PayService_H5Pay_FullMethodName     = "/app.PayService/H5Pay"
	PayService_PayNotify_FullMethodName = "/app.PayService/PayNotify"
)
