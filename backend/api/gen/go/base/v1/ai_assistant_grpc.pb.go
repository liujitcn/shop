...
func (c *aiAssistantServiceClient) SendAiAssistantMessage(ctx context.Context, in *SendAiAssistantMessageRequest, opts ...grpc.CallOption) (*SendAiAssistantMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendAiAssistantMessageResponse)
	err := c.cc.Invoke(ctx, AiAssistantService_SendAiAssistantMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AiAssistantService_SendAiAssistantMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendAiAssistantMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AiAssistantServiceServer).SendAiAssistantMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AiAssistantService_SendAiAssistantMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AiAssistantServiceServer).SendAiAssistantMessage(ctx, req.(*SendAiAssistantMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AiAssistantService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "base/v1/ai_assistant.proto",
}
