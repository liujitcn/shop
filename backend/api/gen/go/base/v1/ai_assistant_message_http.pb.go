...
func RegisterAiAssistantMessageServiceHTTPServer(s *http.Server, srv AiAssistantMessageServiceHTTPServer) {
	r := s.Route("/")
	r.Handle("POST", "/api/v1/base/ai/assistant/session/{session_id}/message", _AiAssistantMessageService_SendAiAssistantMessage0_HTTP_Handler(srv))
	r.Handle("DELETE", "/api/v1/base/ai/assistant/session/{session_id}/message/{message_id}", _AiAssistantMessageService_DeleteAiAssistantMessage0_HTTP_Handler(srv))
	r.Handle("PUT", "/api/v1/base/ai/assistant/session/{session_id}/message/{message_id}", _AiAssistantMessageService_UpdateAiAssistantMessage0_HTTP_Handler(srv))
	r.Handle("POST", "/api/v1/base/ai/assistant/session/{session_id}/message/{message_id}/retry", _AiAssistantMessageService_RetryAiAssistantUserMessage0_HTTP_Handler(srv))
	r.Handle("POST", "/api/v1/base/ai/assistant/session/{session_id}/message/{message_id}/regeneration", _AiAssistantMessageService_RegenerateAiAssistantMessage0_HTTP_Handler(srv))
}
...
func (c *AiAssistantMessageServiceHTTPClientImpl) DeleteAiAssistantMessage(ctx context.Context, in *DeleteAiAssistantMessageRequest, opts ...http.CallOption) (*DeleteAiAssistantMessageResponse, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationAiAssistantMessageServiceDeleteAiAssistantMessage),
...
func (c *AiAssistantMessageServiceHTTPClientImpl) RegenerateAiAssistantMessage(ctx context.Context, in *RegenerateAiAssistantMessageRequest, opts ...http.CallOption) (*SendAiAssistantMessageResponse, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationAiAssistantMessageServiceRegenerateAiAssistantMessage),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *AiAssistantMessageServiceHTTPClientImpl) RetryAiAssistantUserMessage(ctx context.Context, in *RetryAiAssistantUserMessageRequest, opts ...http.CallOption) (*SendAiAssistantMessageResponse, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationAiAssistantMessageServiceRetryAiAssistantUserMessage),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
...
func (c *AiAssistantMessageServiceHTTPClientImpl) SendAiAssistantMessage(ctx context.Context, in *SendAiAssistantMessageRequest, opts ...http.CallOption) (*SendAiAssistantMessageResponse, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationAiAssistantMessageServiceSendAiAssistantMessage),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
...
func (c *AiAssistantMessageServiceHTTPClientImpl) UpdateAiAssistantMessage(ctx context.Context, in *UpdateAiAssistantMessageRequest, opts ...http.CallOption) (*SendAiAssistantMessageResponse, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationAiAssistantMessageServiceUpdateAiAssistantMessage),
		http.PathTemplate(pattern),
	}, opts...)
