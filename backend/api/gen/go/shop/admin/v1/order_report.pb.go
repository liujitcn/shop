...
func (x *SummaryOrderDayReportResponse) Reset() {
	*x = SummaryOrderDayReportResponse{}
	mi := &file_shop_admin_v1_order_report_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SummaryOrderDayReportResponse) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_report_proto_rawDescGZIP(), []int{7}
}
...
var (
	file_shop_admin_v1_order_report_proto_rawDescOnce sync.Once
	file_shop_admin_v1_order_report_proto_rawDescData []byte
)

func file_shop_admin_v1_order_report_proto_rawDescGZIP() []byte {
	file_shop_admin_v1_order_report_proto_rawDescOnce.Do(func() {
		file_shop_admin_v1_order_report_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shop_admin_v1_order_report_proto_rawDesc), len(file_shop_admin_v1_order_report_proto_rawDesc)))
	})
	return file_shop_admin_v1_order_report_proto_rawDescData
}
...
func init() { file_shop_admin_v1_order_report_proto_init() }
func file_shop_admin_v1_order_report_proto_init() {
	if File_shop_admin_v1_order_report_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shop_admin_v1_order_report_proto_rawDesc), len(file_shop_admin_v1_order_report_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_shop_admin_v1_order_report_proto_goTypes,
		DependencyIndexes: file_shop_admin_v1_order_report_proto_depIdxs,
		MessageInfos:      file_shop_admin_v1_order_report_proto_msgTypes,
	}.Build()
	File_shop_admin_v1_order_report_proto = out.File
	file_shop_admin_v1_order_report_proto_goTypes = nil
	file_shop_admin_v1_order_report_proto_depIdxs = nil
}
