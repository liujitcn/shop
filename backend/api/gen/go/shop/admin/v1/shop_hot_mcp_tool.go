...
func RegisterShopHotServicePageShopHotMCPTool(mcpServer *mcp.Server, shopHotServiceServer ShopHotServiceServer) {
	mcp.AddTool[*PageShopHotRequest, *PageShopHotResponse](
		mcpServer,
		&mcp.Tool{
			Name:        "shop_admin_v1_shop_hot_service_page_shop_hot",
...
func RegisterShopHotServicePageShopHotItemMCPTool(mcpServer *mcp.Server, shopHotServiceServer ShopHotServiceServer) {
	mcp.AddTool[*PageShopHotItemRequest, *PageShopHotItemResponse](
		mcpServer,
		&mcp.Tool{
			Name:        "shop_admin_v1_shop_hot_service_page_shop_hot_item",
...
func RegisterShopHotServiceGetShopHotItemMCPTool(mcpServer *mcp.Server, shopHotServiceServer ShopHotServiceServer) {
	mcp.AddTool[*GetShopHotItemRequest, *ShopHotItemForm](
		mcpServer,
		&mcp.Tool{
			Name:        "shop_admin_v1_shop_hot_service_get_shop_hot_item",
...
func RegisterShopHotServiceCreateShopHotItemMCPTool(mcpServer *mcp.Server, shopHotServiceServer ShopHotServiceServer) {
	mcp.AddTool[*CreateShopHotItemRequest, *emptypb.Empty](
		mcpServer,
		&mcp.Tool{
			Name:        "shop_admin_v1_shop_hot_service_create_shop_hot_item",
...
func RegisterShopHotServiceUpdateShopHotItemMCPTool(mcpServer *mcp.Server, shopHotServiceServer ShopHotServiceServer) {
	mcp.AddTool[*UpdateShopHotItemRequest, *emptypb.Empty](
		mcpServer,
		&mcp.Tool{
			Name:        "shop_admin_v1_shop_hot_service_update_shop_hot_item",
...
func RegisterShopHotServiceDeleteShopHotItemMCPTool(mcpServer *mcp.Server, shopHotServiceServer ShopHotServiceServer) {
	mcp.AddTool[*DeleteShopHotItemRequest, *emptypb.Empty](
		mcpServer,
		&mcp.Tool{
			Name:        "shop_admin_v1_shop_hot_service_delete_shop_hot_item",
...
func RegisterShopHotServiceSetShopHotItemStatusMCPTool(mcpServer *mcp.Server, shopHotServiceServer ShopHotServiceServer) {
	mcp.AddTool[*SetShopHotItemStatusRequest, *emptypb.Empty](
		mcpServer,
		&mcp.Tool{
			Name:        "shop_admin_v1_shop_hot_service_set_shop_hot_item_status",
			Description: "设置状态",
		},
