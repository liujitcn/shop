...
const (
	PayBillService_PagePayBill_FullMethodName = "/shop.admin.v1.PayBillService/PagePayBill"
)
...
var PayBillService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shop.admin.v1.PayBillService",
	...
	Metadata: "shop/admin/v1/pay_bill.proto",
}
