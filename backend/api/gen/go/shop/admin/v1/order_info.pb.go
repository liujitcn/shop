...
// 	protoc        (unknown)
// source: shop/admin/v1/order_info.proto
...
type PageOrderInfoRequest struct {
	...
	Status        *v1.OrderInfoStatus    `protobuf:"varint,5,opt,name=status,proto3,enum=shop.common.v1.OrderInfoStatus,oneof" json:"status,omitempty"`                                    // 订单履约状态
	PayType       *v1.OrderPayType       `protobuf:"varint,8,opt,name=pay_type,json=payType,proto3,enum=shop.common.v1.OrderPayType,oneof" json:"pay_type,omitempty"`                      // 支付方式：枚举【OrderPayType】
	PayChannel    *v1.OrderPayChannel    `protobuf:"varint,9,opt,name=pay_channel,json=payChannel,proto3,enum=shop.common.v1.OrderPayChannel,oneof" json:"pay_channel,omitempty"`          // 支付渠道：枚举【OrderPayChannel】
	TradeStatus   *v1.OrderTradeStatus   `protobuf:"varint,10,opt,name=trade_status,json=tradeStatus,proto3,enum=shop.common.v1.OrderTradeStatus,oneof" json:"trade_status,omitempty"`     // 交易支付状态
	RefundStatus  *v1.OrderRefundStatus  `protobuf:"varint,11,opt,name=refund_status,json=refundStatus,proto3,enum=shop.common.v1.OrderRefundStatus,oneof" json:"refund_status,omitempty"` // 订单退款状态
...
func (x *PageOrderInfoRequest) Reset() {
	*x = PageOrderInfoRequest{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[0]
...
func (*PageOrderInfoRequest) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{0}
}
...
func (x *PageOrderInfoResponse) Reset() {
	*x = PageOrderInfoResponse{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PageOrderInfoResponse) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetOrderInfoRequest) Reset() {
	*x = GetOrderInfoRequest{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetOrderInfoRequest) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{2}
}
...
func (x *ShipOrderInfoRequest) Reset() {
	*x = ShipOrderInfoRequest{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ShipOrderInfoRequest) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{9}
}
...
type OrderInfo struct {
	...
	DeliveryTime  v1.OrderDeliveryTime   `protobuf:"varint,11,opt,name=delivery_time,json=deliveryTime,proto3,enum=shop.common.v1.OrderDeliveryTime" json:"delivery_time,omitempty"` // 配送时间：枚举【OrderDeliveryTime】
	Status        v1.OrderInfoStatus     `protobuf:"varint,12,opt,name=status,proto3,enum=shop.common.v1.OrderInfoStatus" json:"status,omitempty"`                                   // 订单履约状态：枚举【OrderInfoStatus】
	RefundStatus  v1.OrderRefundStatus   `protobuf:"varint,13,opt,name=refund_status,json=refundStatus,proto3,enum=shop.common.v1.OrderRefundStatus" json:"refund_status,omitempty"` // 订单退款状态：枚举【OrderRefundStatus】
	...
	PayType       v1.OrderPayType        `protobuf:"varint,17,opt,name=pay_type,json=payType,proto3,enum=shop.common.v1.OrderPayType" json:"pay_type,omitempty"`                     // 支付方式：枚举【OrderPayType】
	PayChannel    v1.OrderPayChannel     `protobuf:"varint,18,opt,name=pay_channel,json=payChannel,proto3,enum=shop.common.v1.OrderPayChannel" json:"pay_channel,omitempty"`         // 支付渠道：枚举【OrderPayChannel】
	TradeNo       string                 `protobuf:"bytes,19,opt,name=trade_no,json=tradeNo,proto3" json:"trade_no,omitempty"`                                                       // 交易单编号
	TradeStatus   v1.OrderTradeStatus    `protobuf:"varint,20,opt,name=trade_status,json=tradeStatus,proto3,enum=shop.common.v1.OrderTradeStatus" json:"trade_status,omitempty"`     // 交易支付状态：枚举【OrderTradeStatus】
...
func (x *OrderInfo) Reset() {
	*x = OrderInfo{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderInfo) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{10}
}
...
func (x *OrderAddress) Reset() {
	*x = OrderAddress{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderAddress) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{11}
}
...
type OrderCancel struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Reason        v1.OrderCancelReason   `protobuf:"varint,1,opt,name=reason,proto3,enum=shop.common.v1.OrderCancelReason" json:"reason,omitempty"` // 取消原因：枚举【OrderCancelReason】
...
func (x *OrderCancel) Reset() {
	*x = OrderCancel{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderCancel) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{12}
}
...
func (x *OrderGoods) Reset() {
	*x = OrderGoods{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderGoods) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{13}
}
...
func (x *OrderLogistics) Reset() {
	*x = OrderLogistics{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderLogistics) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{14}
}
...
type OrderPayment struct {
	...
	Status         v1.OrderBillStatus      `protobuf:"varint,12,opt,name=status,proto3,enum=shop.common.v1.OrderBillStatus" json:"status,omitempty"`   // 对账状态：枚举【OrderBillStatus】
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *OrderPayment) Reset() {
	*x = OrderPayment{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderPayment) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{15}
}
...
type OrderRefund struct {
	...
	Reason              v1.OrderRefundReason   `protobuf:"varint,6,opt,name=reason,proto3,enum=shop.common.v1.OrderRefundReason" json:"reason,omitempty"`                 // 退款原因：枚举【OrderRefundReason】
	...
	Status              v1.OrderBillStatus     `protobuf:"varint,15,opt,name=status,proto3,enum=shop.common.v1.OrderBillStatus" json:"status,omitempty"`                  // 对账状态：枚举【OrderBillStatus】
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *OrderRefund) Reset() {
	*x = OrderRefund{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderRefund) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{16}
}
...
func (x *OrderLogistics_Detail) Reset() {
	*x = OrderLogistics_Detail{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderLogistics_Detail) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{14, 0}
}
...
func (x *OrderPayment_Payer) Reset() {
	*x = OrderPayment_Payer{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderPayment_Payer) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{15, 0}
}
...
func (x *OrderPayment_Amount) Reset() {
	*x = OrderPayment_Amount{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderPayment_Amount) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{15, 1}
}
...
func (x *OrderPayment_SceneInfo) Reset() {
	*x = OrderPayment_SceneInfo{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderPayment_SceneInfo) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{15, 2}
}
...
func (x *OrderRefund_Amount) Reset() {
	*x = OrderRefund_Amount{}
	mi := &file_shop_admin_v1_order_info_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderRefund_Amount) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_order_info_proto_rawDescGZIP(), []int{16, 0}
}
...
var File_shop_admin_v1_order_info_proto protoreflect.FileDescriptor
...
const file_shop_admin_v1_order_info_proto_rawDesc = "" +
	...
	"\auser_id\x18\x04 \x01(\x03B\x0e\xbaG\v\x92\x02\b用户idR\x06userId\x12V\n" +
	"\x06status\x18\x05 \x01(\x0e2\x1f.shop.common.v1.OrderInfoStatusB\x18\xbaG\x15\x92\x02\x12订单履约状态H\x02R\x06status\x88\x01\x01\x12k\n" +
	"\bpay_type\x18\b \x01(\x0e2\x1c.shop.common.v1.OrderPayTypeB-\xbaG*\x92\x02'支付方式：枚举【OrderPayType】H\x03R\apayType\x88\x01\x01\x12w\n" +
	"\vpay_channel\x18\t \x01(\x0e2\x1f.shop.common.v1.OrderPayChannelB0\xbaG-\x92\x02*支付渠道：枚举【OrderPayChannel】H\x04R\n" +
	"payChannel\x88\x01\x01\x12b\n" +
	"\ftrade_status\x18\n" +
	" \x01(\x0e2 .shop.common.v1.OrderTradeStatusB\x18\xbaG\x15\x92\x02\x12交易支付状态H\x05R\vtradeStatus\x88\x01\x01\x12e\n" +
	"\rrefund_status\x18\v \x01(\x0e2!.shop.common.v1.OrderRefundStatusB\x18\xbaG\x15\x92\x02\x12订单退款状态H\x06R\frefundStatus\x88\x01\x01\x122\n" +
	"\n" +
	...
	"\f_pay_channelB\x0f\n" +
	"\r_trade_statusB\x10\n" +
	"\x0e_refund_status\"\x90\x01\n" +
	"\x15PageOrderInfoResponse\x12S\n" +
	"\vorder_infos\x18\x01 \x03(\v2\x18.shop.admin.v1.OrderInfoB\x18\xbaG\x15\x92\x02\x12订单分页数据R\n" +
	"orderInfos\x12\"\n" +
	...
	"\tcountdown\x18\x02 \x01(\x02B\x15\xbaG\x12\x92\x02\x0f支付倒计时R\tcountdown\x12I\n" +
	"\aaddress\x18d \x01(\v2\x1b.shop.admin.v1.OrderAddressB\x12\xbaG\x0f\x92\x02\f地址信息R\aaddress\x12F\n" +
	"\x06cancel\x18e \x01(\v2\x1a.shop.admin.v1.OrderCancelB\x12\xbaG\x0f\x92\x02\f取消信息R\x06cancel\x12C\n" +
	...
	"\tgoods_num\x18\n" +
	" \x01(\x03B\x12\xbaG\x0f\x92\x02\f商品总数R\bgoodsNum\x12z\n" +
	"\rdelivery_time\x18\v \x01(\x0e2!.shop.common.v1.OrderDeliveryTimeB2\xbaG/\x92\x02,配送时间：枚举【OrderDeliveryTime】R\fdeliveryTime\x12o\n" +
	"\x06status\x18\f \x01(\x0e2\x1f.shop.common.v1.OrderInfoStatusB6\xbaG3\x92\x020订单履约状态：枚举【OrderInfoStatus】R\x06status\x12\x80\x01\n" +
	"\rrefund_status\x18\r \x01(\x0e2!.shop.common.v1.OrderRefundStatusB8\xbaG5\x92\x022订单退款状态：枚举【OrderRefundStatus】R\frefundStatus\x12*\n" +
	...
	"\n" +
	"updated_at\x18\x10 \x01(\tB\x12\xbaG\x0f\x92\x02\f更新时间R\tupdatedAt\x12f\n" +
	"\bpay_type\x18\x11 \x01(\x0e2\x1c.shop.common.v1.OrderPayTypeB-\xbaG*\x92\x02'支付方式：枚举【OrderPayType】R\apayType\x12r\n" +
	"\vpay_channel\x18\x12 \x01(\x0e2\x1f.shop.common.v1.OrderPayChannelB0\xbaG-\x92\x02*支付渠道：枚举【OrderPayChannel】R\n" +
	"payChannel\x120\n" +
	"\btrade_no\x18\x13 \x01(\tB\x15\xbaG\x12\x92\x02\x0f交易单编号R\atradeNo\x12|\n" +
	"\ftrade_status\x18\x14 \x01(\x0e2 .shop.common.v1.OrderTradeStatusB7\xbaG4\x92\x021交易支付状态：枚举【OrderTradeStatus】R\vtradeStatus\x12,\n" +
	...
	"\x06detail\x18\x04 \x01(\tB\x12\xbaG\x0f\x92\x02\f详细地址R\x06detail\"\xaf\x01\n" +
	"\vOrderCancel\x12m\n" +
	"\x06reason\x18\x01 \x01(\x0e2!.shop.common.v1.OrderCancelReasonB2\xbaG/\x92\x02,取消原因：枚举【OrderCancelReason】R\x06reason\x121\n" +
	"\n" +
	...
	" \x01(\x03B\x18\xbaG\x15\x92\x02\x12支付金额汇总R\rtotalPayPrice\"\xf0\x02\n" +
	...
	"\x06detail\x18\x04 \x03(\v2$.shop.admin.v1.OrderLogistics.DetailB\"\xbaG\x1f\x92\x02\x1c物流详情（JSON存储）R\x06detail\x121\n" +
	"\n" +
	...
	"\x04text\x18\x02 \x01(\tB\f\xbaG\t\x92\x02\x06动态R\x04text\"\xce\x0e\n" +
	"\fOrderPayment\x12,\n" +
	...
	"\fsuccess_time\x18\b \x01(\tB\x18\xbaG\x15\x92\x02\x12支付完成时间R\vsuccessTime\x12^\n" +
	"\x05payer\x18\t \x01(\v2!.shop.admin.v1.OrderPayment.PayerB%\xbaG\"\x92\x02\x1f支付者信息（JSON存储）R\x05payer\x12^\n" +
	"\x06amount\x18\n" +
	" \x01(\v2\".shop.admin.v1.OrderPayment.AmountB\"\xbaG\x1f\x92\x02\x1c订单金额（JSON存储）R\x06amount\x12h\n" +
	"\n" +
	"scene_info\x18\v \x01(\v2%.shop.admin.v1.OrderPayment.SceneInfoB\"\xbaG\x1f\x92\x02\x1c场景信息（JSON存储）R\tsceneInfo\x12i\n" +
	"\x06status\x18\f \x01(\x0e2\x1f.shop.common.v1.OrderBillStatusB0\xbaG-\x92\x02*对账状态：枚举【OrderBillStatus】R\x06status\x1a_\n" +
	"\x05Payer\x12V\n" +
	...
	"\tSceneInfo\x12S\n" +
	"\tdevice_id\x18\x01 \x01(\tB6\xbaG3\x92\x020【商户端设备号】门店号/收银设备IDR\bdeviceId\"\xf7\f\n" +
	"\vOrderRefund\x12,\n" +
	...
	"\trefund_no\x18\x05 \x01(\tB\x12\xbaG\x0f\x92\x02\f退款编号R\brefundNo\x12m\n" +
	"\x06reason\x18\x06 \x01(\x0e2!.shop.common.v1.OrderRefundReasonB2\xbaG/\x92\x02,退款原因：枚举【OrderRefundReason】R\x06reason\x12@\n" +
	...
	"\rfunds_account\x18\r \x01(\tBh\xbaGe\x92\x02b资金账户类型（UNSETTLED：未结算，AVAILABLE：可用余额，BASIC：基本账户等）R\ffundsAccount\x12]\n" +
	"\x06amount\x18\x0e \x01(\v2!.shop.admin.v1.OrderRefund.AmountB\"\xbaG\x1f\x92\x02\x1c金额信息（JSON存储）R\x06amount\x12i\n" +
	"\x06status\x18\x0f \x01(\x0e2\x1f.shop.common.v1.OrderBillStatusB0\xbaG-\x92\x02*对账状态：枚举【OrderBillStatus】R\x06status\x1a\xa7\x02\n" +
	"\x06Amount\x12=\n" +
	...
	"payerTotal\x12M\n" +
	"\fpayer_refund\x18\x04 \x01(\x03B*\xbaG'\x92\x02$【用户退款金额】单位：分R\vpayerRefund2\xd1\x06\n" +
...
var (
	file_shop_admin_v1_order_info_proto_rawDescOnce sync.Once
	file_shop_admin_v1_order_info_proto_rawDescData []byte
)

func file_shop_admin_v1_order_info_proto_rawDescGZIP() []byte {
	file_shop_admin_v1_order_info_proto_rawDescOnce.Do(func() {
		file_shop_admin_v1_order_info_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shop_admin_v1_order_info_proto_rawDesc), len(file_shop_admin_v1_order_info_proto_rawDesc)))
	})
	return file_shop_admin_v1_order_info_proto_rawDescData
}

var file_shop_admin_v1_order_info_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_shop_admin_v1_order_info_proto_goTypes = []any{
	...
	(*OrderCancel)(nil),                 // 12: shop.admin.v1.OrderCancel
	(*OrderGoods)(nil),                  // 13: shop.admin.v1.OrderGoods
	(*OrderLogistics)(nil),              // 14: shop.admin.v1.OrderLogistics
	(*OrderPayment)(nil),                // 15: shop.admin.v1.OrderPayment
	(*OrderRefund)(nil),                 // 16: shop.admin.v1.OrderRefund
	(*OrderLogistics_Detail)(nil),       // 17: shop.admin.v1.OrderLogistics.Detail
	(*OrderPayment_Payer)(nil),          // 18: shop.admin.v1.OrderPayment.Payer
	(*OrderPayment_Amount)(nil),         // 19: shop.admin.v1.OrderPayment.Amount
	(*OrderPayment_SceneInfo)(nil),      // 20: shop.admin.v1.OrderPayment.SceneInfo
	(*OrderRefund_Amount)(nil),          // 21: shop.admin.v1.OrderRefund.Amount
	(v1.OrderInfoStatus)(0),             // 22: shop.common.v1.OrderInfoStatus
	(v1.OrderPayType)(0),                // 23: shop.common.v1.OrderPayType
	(v1.OrderPayChannel)(0),             // 24: shop.common.v1.OrderPayChannel
	(v1.OrderTradeStatus)(0),            // 25: shop.common.v1.OrderTradeStatus
	(v1.OrderRefundStatus)(0),           // 26: shop.common.v1.OrderRefundStatus
	(v1.OrderRefundReason)(0),           // 27: shop.common.v1.OrderRefundReason
	(v1.OrderDeliveryTime)(0),           // 28: shop.common.v1.OrderDeliveryTime
	(v1.OrderCancelReason)(0),           // 29: shop.common.v1.OrderCancelReason
	(v1.OrderBillStatus)(0),             // 30: shop.common.v1.OrderBillStatus
	(*emptypb.Empty)(nil),               // 31: google.protobuf.Empty
}
var file_shop_admin_v1_order_info_proto_depIdxs = []int32{
	22, // 0: shop.admin.v1.PageOrderInfoRequest.status:type_name -> shop.common.v1.OrderInfoStatus
	23, // 1: shop.admin.v1.PageOrderInfoRequest.pay_type:type_name -> shop.common.v1.OrderPayType
	24, // 2: shop.admin.v1.PageOrderInfoRequest.pay_channel:type_name -> shop.common.v1.OrderPayChannel
	25, // 3: shop.admin.v1.PageOrderInfoRequest.trade_status:type_name -> shop.common.v1.OrderTradeStatus
	26, // 4: shop.admin.v1.PageOrderInfoRequest.refund_status:type_name -> shop.common.v1.OrderRefundStatus
	10, // 5: shop.admin.v1.PageOrderInfoResponse.order_infos:type_name -> shop.admin.v1.OrderInfo
	10, // 6: shop.admin.v1.OrderInfoResponse.order:type_name -> shop.admin.v1.OrderInfo
	11, // 7: shop.admin.v1.OrderInfoResponse.address:type_name -> shop.admin.v1.OrderAddress
	12, // 8: shop.admin.v1.OrderInfoResponse.cancel:type_name -> shop.admin.v1.OrderCancel
	13, // 9: shop.admin.v1.OrderInfoResponse.goods:type_name -> shop.admin.v1.OrderGoods
	14, // 10: shop.admin.v1.OrderInfoResponse.logistics:type_name -> shop.admin.v1.OrderLogistics
	15, // 11: shop.admin.v1.OrderInfoResponse.payment:type_name -> shop.admin.v1.OrderPayment
	...
	23, // 22: shop.admin.v1.OrderInfo.pay_type:type_name -> shop.common.v1.OrderPayType
	24, // 23: shop.admin.v1.OrderInfo.pay_channel:type_name -> shop.common.v1.OrderPayChannel
	25, // 24: shop.admin.v1.OrderInfo.trade_status:type_name -> shop.common.v1.OrderTradeStatus
	29, // 25: shop.admin.v1.OrderCancel.reason:type_name -> shop.common.v1.OrderCancelReason
	17, // 26: shop.admin.v1.OrderLogistics.detail:type_name -> shop.admin.v1.OrderLogistics.Detail
	18, // 27: shop.admin.v1.OrderPayment.payer:type_name -> shop.admin.v1.OrderPayment.Payer
	19, // 28: shop.admin.v1.OrderPayment.amount:type_name -> shop.admin.v1.OrderPayment.Amount
	20, // 29: shop.admin.v1.OrderPayment.scene_info:type_name -> shop.admin.v1.OrderPayment.SceneInfo
	30, // 30: shop.admin.v1.OrderPayment.status:type_name -> shop.common.v1.OrderBillStatus
	27, // 31: shop.admin.v1.OrderRefund.reason:type_name -> shop.common.v1.OrderRefundReason
	21, // 32: shop.admin.v1.OrderRefund.amount:type_name -> shop.admin.v1.OrderRefund.Amount
...
func init() { file_shop_admin_v1_order_info_proto_init() }
func file_shop_admin_v1_order_info_proto_init() {
	if File_shop_admin_v1_order_info_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shop_admin_v1_order_info_proto_rawDesc), len(file_shop_admin_v1_order_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_shop_admin_v1_order_info_proto_goTypes,
		DependencyIndexes: file_shop_admin_v1_order_info_proto_depIdxs,
		MessageInfos:      file_shop_admin_v1_order_info_proto_msgTypes,
	}.Build()
	File_shop_admin_v1_order_info_proto = out.File
	file_shop_admin_v1_order_info_proto_goTypes = nil
	file_shop_admin_v1_order_info_proto_depIdxs = nil
}
