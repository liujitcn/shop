...
func (x *PageShopHotRequest) Reset() {
	*x = PageShopHotRequest{}
	mi := &file_shop_admin_v1_shop_hot_proto_msgTypes[0]
...
func (*PageShopHotRequest) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_shop_hot_proto_rawDescGZIP(), []int{0}
}
...
func (x *PageShopHotResponse) Reset() {
	*x = PageShopHotResponse{}
	mi := &file_shop_admin_v1_shop_hot_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PageShopHotResponse) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_shop_hot_proto_rawDescGZIP(), []int{1}
}
...
func (x *UpdateShopHotItemRequest) Reset() {
	*x = UpdateShopHotItemRequest{}
	mi := &file_shop_admin_v1_shop_hot_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateShopHotItemRequest) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_shop_hot_proto_rawDescGZIP(), []int{11}
}
...
const file_shop_admin_v1_shop_hot_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\x03B\x17\xbaG\x14\x92\x02\x11热门专区项IDR\x02id\"\xb3\x04\n" +
	"\x0fShopHotItemForm\x12*\n" +
	"\x02id\x18\x01 \x01(\x03B\x1a\xbaG\x17\x92\x02\x14商城热门推荐IDR\x02id\x121\n" +
	"\x06hot_id\x18\x02 \x01(\x03B\x1a\xbaG\x17\x92\x02\x14商城热门推荐IDR\x05hotId\x12\xd0\x01\n" +
	"\x05title\x18\x03 \x01(\tB\xb9\x01\xbaG\t\x92\x02\x06标题\xbaH\xa9\x01\xba\x01R\n" +
	"\x1cshop_hot_item.title.required\x12!请输入热门推荐选项标题\x1a\x0fthis.size() > 0\xba\x01Q\n" +
	"\x1bshop_hot_item.title.max_len\x12\x1f标题不能超过 64 个字符\x1a\x11this.size() <= 64R\x05title\x12c\n" +
	...
	"\bshop_hot\x18\x01 \x01(\v2\x1a.shop.admin.v1.ShopHotFormB\x1e\xbaG\x15\x92\x02\x12热门专区表单\xbaH\x03\xc8\x01\x01R\ashopHot\"\x81\x01\n" +
	"\x18CreateShopHotItemRequest\x12e\n" +
	"\rshop_hot_item\x18\x01 \x01(\v2\x1e.shop.admin.v1.ShopHotItemFormB!\xbaG\x18\x92\x02\x15热门专区项表单\xbaH\x03\xc8\x01\x01R\vshopHotItem\"\x99\x01\n" +
	"\x14UpdateShopHotRequest\x12*\n" +
	"\x02id\x18\x01 \x01(\x03B\x1a\xbaG\x17\x92\x02\x14商城热门推荐IDR\x02id\x12U\n" +
	"\bshop_hot\x18\x02 \x01(\v2\x1a.shop.admin.v1.ShopHotFormB\x1e\xbaG\x15\x92\x02\x12热门专区表单\xbaH\x03\xc8\x01\x01R\ashopHot\"\xaa\x01\n" +
	"\x18UpdateShopHotItemRequest\x12'\n" +
	"\x02id\x18\x01 \x01(\x03B\x17\xbaG\x14\x92\x02\x11热门专区项IDR\x02id\x12e\n" +
	"\rshop_hot_item\x18\x02 \x01(\v2\x1e.shop.admin.v1.ShopHotItemFormB!\xbaG\x18\x92\x02\x15热门专区项表单\xbaH\x03\xc8\x01\x01R\vshopHotItem\"\\\n" +
...
var (
	file_shop_admin_v1_shop_hot_proto_rawDescOnce sync.Once
	file_shop_admin_v1_shop_hot_proto_rawDescData []byte
)

func file_shop_admin_v1_shop_hot_proto_rawDescGZIP() []byte {
	file_shop_admin_v1_shop_hot_proto_rawDescOnce.Do(func() {
		file_shop_admin_v1_shop_hot_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shop_admin_v1_shop_hot_proto_rawDesc), len(file_shop_admin_v1_shop_hot_proto_rawDesc)))
	})
	return file_shop_admin_v1_shop_hot_proto_rawDescData
}

var file_shop_admin_v1_shop_hot_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
...
func init() { file_shop_admin_v1_shop_hot_proto_init() }
func file_shop_admin_v1_shop_hot_proto_init() {
	if File_shop_admin_v1_shop_hot_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shop_admin_v1_shop_hot_proto_rawDesc), len(file_shop_admin_v1_shop_hot_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_shop_admin_v1_shop_hot_proto_goTypes,
		DependencyIndexes: file_shop_admin_v1_shop_hot_proto_depIdxs,
		MessageInfos:      file_shop_admin_v1_shop_hot_proto_msgTypes,
	}.Build()
	File_shop_admin_v1_shop_hot_proto = out.File
	file_shop_admin_v1_shop_hot_proto_goTypes = nil
	file_shop_admin_v1_shop_hot_proto_depIdxs = nil
}
