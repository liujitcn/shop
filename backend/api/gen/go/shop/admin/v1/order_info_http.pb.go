...
const OperationOrderInfoServiceGetOrderInfo = "/shop.admin.v1.OrderInfoService/GetOrderInfo"
const OperationOrderInfoServiceGetOrderInfoRefund = "/shop.admin.v1.OrderInfoService/GetOrderInfoRefund"
const OperationOrderInfoServiceGetOrderInfoShipment = "/shop.admin.v1.OrderInfoService/GetOrderInfoShipment"
const OperationOrderInfoServicePageOrderInfo = "/shop.admin.v1.OrderInfoService/PageOrderInfo"
const OperationOrderInfoServiceRefundOrderInfo = "/shop.admin.v1.OrderInfoService/RefundOrderInfo"
const OperationOrderInfoServiceShipOrderInfo = "/shop.admin.v1.OrderInfoService/ShipOrderInfo"
...
func (c *OrderInfoServiceHTTPClientImpl) GetOrderInfo(ctx context.Context, in *GetOrderInfoRequest, opts ...http.CallOption) (*OrderInfoResponse, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationOrderInfoServiceGetOrderInfo),
...
func (c *OrderInfoServiceHTTPClientImpl) GetOrderInfoRefund(ctx context.Context, in *GetOrderInfoRefundRequest, opts ...http.CallOption) (*OrderInfoRefundResponse, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationOrderInfoServiceGetOrderInfoRefund),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *OrderInfoServiceHTTPClientImpl) GetOrderInfoShipment(ctx context.Context, in *GetOrderInfoShipmentRequest, opts ...http.CallOption) (*OrderInfoShipmentForm, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationOrderInfoServiceGetOrderInfoShipment),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *OrderInfoServiceHTTPClientImpl) ShipOrderInfo(ctx context.Context, in *ShipOrderInfoRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationOrderInfoServiceShipOrderInfo),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
