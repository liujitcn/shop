...
type PageRecommendRequestRequest struct {
	...
	ActorType     *v1.RecommendActorType `protobuf:"varint,2,opt,name=actor_type,json=actorType,proto3,enum=shop.common.v1.RecommendActorType,oneof" json:"actor_type,omitempty"` // 主体类型：字典【recommend_actor_type】
	ActorId       *int64                 `protobuf:"varint,3,opt,name=actor_id,json=actorId,proto3,oneof" json:"actor_id,omitempty"`                                              // 主体编号（仅内部定位使用）
	Scene         *v1.RecommendScene     `protobuf:"varint,4,opt,name=scene,proto3,enum=shop.common.v1.RecommendScene,oneof" json:"scene,omitempty"`                              // 推荐场景：字典【recommend_scene】
...
func (x *PageRecommendRequestRequest) Reset() {
	*x = PageRecommendRequestRequest{}
	mi := &file_shop_admin_v1_recommend_request_proto_msgTypes[0]
...
func (*PageRecommendRequestRequest) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_recommend_request_proto_rawDescGZIP(), []int{0}
}
...
func (x *PageRecommendRequestResponse) Reset() {
	*x = PageRecommendRequestResponse{}
	mi := &file_shop_admin_v1_recommend_request_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PageRecommendRequestResponse) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_recommend_request_proto_rawDescGZIP(), []int{1}
}
...
type RecommendRequest struct {
	...
	ActorType     v1.RecommendActorType  `protobuf:"varint,3,opt,name=actor_type,json=actorType,proto3,enum=shop.common.v1.RecommendActorType" json:"actor_type,omitempty"` // 主体类型：字典【recommend_actor_type】
	ActorId       int64                  `protobuf:"varint,4,opt,name=actor_id,json=actorId,proto3" json:"actor_id,omitempty"`                                              // 主体编号（仅内部定位使用）
	Scene         v1.RecommendScene      `protobuf:"varint,5,opt,name=scene,proto3,enum=shop.common.v1.RecommendScene" json:"scene,omitempty"`                              // 推荐场景：字典【recommend_scene】
	...
	Strategy      v1.RecommendStrategy   `protobuf:"varint,9,opt,name=strategy,proto3,enum=shop.common.v1.RecommendStrategy" json:"strategy,omitempty"`                     // 命中的推荐策略：字典【recommend_strategy】
...
type RecommendRequestContext struct {
	...
	Strategy          v1.RecommendStrategy     `protobuf:"varint,5,opt,name=strategy,proto3,enum=shop.common.v1.RecommendStrategy" json:"strategy,omitempty"`         // 命中的推荐策略：字典【recommend_strategy】
...
type RecommendRequestItem struct {
	...
	GoodsStatus   v1.GoodsStatus         `protobuf:"varint,7,opt,name=goods_status,json=goodsStatus,proto3,enum=shop.common.v1.GoodsStatus" json:"goods_status,omitempty"` // 商品状态：枚举【GoodsStatus】
...
type RecommendEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                                                       // 主键ID
	ActorType     v1.RecommendActorType  `protobuf:"varint,2,opt,name=actor_type,json=actorType,proto3,enum=shop.common.v1.RecommendActorType" json:"actor_type,omitempty"` // 主体类型：字典【recommend_actor_type】
	ActorId       int64                  `protobuf:"varint,3,opt,name=actor_id,json=actorId,proto3" json:"actor_id,omitempty"`                                              // 主体编号（仅内部定位使用）
	Scene         v1.RecommendScene      `protobuf:"varint,4,opt,name=scene,proto3,enum=shop.common.v1.RecommendScene" json:"scene,omitempty"`                              // 推荐场景：字典【recommend_scene】
	EventType     v1.RecommendEventType  `protobuf:"varint,5,opt,name=event_type,json=eventType,proto3,enum=shop.common.v1.RecommendEventType" json:"event_type,omitempty"` // 事件类型：枚举【RecommendEventType】
...
func (x *RecommendEvent) Reset() {
	*x = RecommendEvent{}
	mi := &file_shop_admin_v1_recommend_request_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecommendEvent) Descriptor() ([]byte, []int) {
	return file_shop_admin_v1_recommend_request_proto_rawDescGZIP(), []int{10}
}
...
var File_shop_admin_v1_recommend_request_proto protoreflect.FileDescriptor
...
const file_shop_admin_v1_recommend_request_proto_rawDesc = "" +
	...
	"\n" +
	"actor_type\x18\x02 \x01(\x0e2\".shop.common.v1.RecommendActorTypeB5\xbaG2\x92\x02/主体类型：字典【recommend_actor_type】H\x01R\tactorType\x88\x01\x01\x12M\n" +
	"\bactor_id\x18\x03 \x01(\x03B-\xbaG*\x92\x02'主体编号（仅内部定位使用）H\x02R\aactorId\x88\x01\x01\x12k\n" +
	"\x05scene\x18\x04 \x01(\x0e2\x1e.shop.common.v1.RecommendSceneB0\xbaG-\x92\x02*推荐场景：字典【recommend_scene】H\x03R\x05scene\x88\x01\x01\x121\n" +
	"\n" +
	...
	"\n" +
	"request_id\x18\x02 \x01(\tB\x14\xbaG\x11\x92\x02\x0e推荐请求IDR\trequestId\x12x\n" +
	"\n" +
	"actor_type\x18\x03 \x01(\x0e2\".shop.common.v1.RecommendActorTypeB5\xbaG2\x92\x02/主体类型：字典【recommend_actor_type】R\tactorType\x12H\n" +
	"\bactor_id\x18\x04 \x01(\x03B-\xbaG*\x92\x02'主体编号（仅内部定位使用）R\aactorId\x12f\n" +
	"\x05scene\x18\x05 \x01(\x0e2\x1e.shop.common.v1.RecommendSceneB0\xbaG-\x92\x02*推荐场景：字典【recommend_scene】R\x05scene\x12'\n" +
	...
	"\x05total\x18\b \x01(\x05B\x18\xbaG\x15\x92\x02\x12本次返回总数R\x05total\x12{\n" +
	"\bstrategy\x18\t \x01(\x0e2!.shop.common.v1.RecommendStrategyB<\xbaG9\x92\x026命中的推荐策略：字典【recommend_strategy】R\bstrategy\x12C\n" +
	"\rprovider_name\x18\n" +
	...
	"\x11context_goods_ids\x18\x04 \x03(\x03B\x1d\xbaG\x1a\x92\x02\x17上下文商品ID列表R\x0fcontextGoodsIds\x12{\n" +
	"\bstrategy\x18\x05 \x01(\x0e2!.shop.common.v1.RecommendStrategyB<\xbaG9\x92\x026命中的推荐策略：字典【recommend_strategy】R\bstrategy\x12F\n" +
	"\rprovider_name\x18\x06 \x01(\tB!\xbaG\x1e\x92\x02\x1b上下文记录的推荐器R\fproviderName\x12N\n" +
	"\x13final_provider_name\x18\a \x01(\tB\x1e\xbaG\x1b\x92\x02\x18最终命中的推荐器R\x11finalProviderName\x12Z\n" +
	"\x05trace\x18\b \x03(\v2$.shop.admin.v1.RecommendRequestTraceB\x1e\xbaG\x1b\x92\x02\x18推荐请求链路轨迹R\x05trace\x124\n" +
	...
	"\bis_final\x18\x05 \x01(\bB6\xbaG3\x92\x020当前推荐器是否为最终命中的推荐器R\aisFinal\"\xf2\x03\n" +
	...
	"\n" +
	"actor_type\x18\x02 \x01(\x0e2\".shop.common.v1.RecommendActorTypeB5\xbaG2\x92\x02/主体类型：字典【recommend_actor_type】R\tactorType\x12H\n" +
	"\bactor_id\x18\x03 \x01(\x03B-\xbaG*\x92\x02'主体编号（仅内部定位使用）R\aactorId\x12f\n" +
	"\x05scene\x18\x04 \x01(\x0e2\x1e.shop.common.v1.RecommendSceneB0\xbaG-\x92\x02*推荐场景：字典【recommend_scene】R\x05scene\x12v\n" +
	"\n" +
	"event_type\x18\x05 \x01(\x0e2\".shop.common.v1.RecommendEventTypeB3\xbaG0\x92\x02-事件类型：枚举【RecommendEventType】R\teventType\x12)\n" +
...
var (
	file_shop_admin_v1_recommend_request_proto_rawDescOnce sync.Once
	file_shop_admin_v1_recommend_request_proto_rawDescData []byte
)

func file_shop_admin_v1_recommend_request_proto_rawDescGZIP() []byte {
	file_shop_admin_v1_recommend_request_proto_rawDescOnce.Do(func() {
		file_shop_admin_v1_recommend_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shop_admin_v1_recommend_request_proto_rawDesc), len(file_shop_admin_v1_recommend_request_proto_rawDesc)))
	})
	return file_shop_admin_v1_recommend_request_proto_rawDescData
}

var file_shop_admin_v1_recommend_request_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_shop_admin_v1_recommend_request_proto_goTypes = []any{
	...
	(v1.RecommendStrategy)(0),                 // 13: shop.common.v1.RecommendStrategy
	(v1.GoodsStatus)(0),                       // 14: shop.common.v1.GoodsStatus
	(v1.RecommendEventType)(0),                // 15: shop.common.v1.RecommendEventType
}
...
func init() { file_shop_admin_v1_recommend_request_proto_init() }
func file_shop_admin_v1_recommend_request_proto_init() {
	if File_shop_admin_v1_recommend_request_proto != nil {
		return
	}
	file_shop_admin_v1_recommend_request_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shop_admin_v1_recommend_request_proto_rawDesc), len(file_shop_admin_v1_recommend_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_shop_admin_v1_recommend_request_proto_goTypes,
		DependencyIndexes: file_shop_admin_v1_recommend_request_proto_depIdxs,
		MessageInfos:      file_shop_admin_v1_recommend_request_proto_msgTypes,
	}.Build()
	File_shop_admin_v1_recommend_request_proto = out.File
	file_shop_admin_v1_recommend_request_proto_goTypes = nil
	file_shop_admin_v1_recommend_request_proto_depIdxs = nil
}
