...
const OperationOrderInfoServiceBuyNowOrderInfo = "/shop.app.v1.OrderInfoService/BuyNowOrderInfo"
const OperationOrderInfoServiceCancelOrderInfo = "/shop.app.v1.OrderInfoService/CancelOrderInfo"
const OperationOrderInfoServiceConfirmOrderInfo = "/shop.app.v1.OrderInfoService/ConfirmOrderInfo"
const OperationOrderInfoServiceCountOrderInfo = "/shop.app.v1.OrderInfoService/CountOrderInfo"
const OperationOrderInfoServiceCreateOrderInfo = "/shop.app.v1.OrderInfoService/CreateOrderInfo"
const OperationOrderInfoServiceDeleteOrderInfo = "/shop.app.v1.OrderInfoService/DeleteOrderInfo"
const OperationOrderInfoServiceDeleteOrderTrade = "/shop.app.v1.OrderInfoService/DeleteOrderTrade"
const OperationOrderInfoServiceGetOrderInfoById = "/shop.app.v1.OrderInfoService/GetOrderInfoById"
const OperationOrderInfoServiceGetOrderInfoIdByOrderNo = "/shop.app.v1.OrderInfoService/GetOrderInfoIdByOrderNo"
const OperationOrderInfoServiceGetOrderTradeById = "/shop.app.v1.OrderInfoService/GetOrderTradeById"
const OperationOrderInfoServicePageOrderInfo = "/shop.app.v1.OrderInfoService/PageOrderInfo"
const OperationOrderInfoServiceReceiveOrderInfo = "/shop.app.v1.OrderInfoService/ReceiveOrderInfo"
const OperationOrderInfoServiceRefundOrderInfo = "/shop.app.v1.OrderInfoService/RefundOrderInfo"
const OperationOrderInfoServiceRepurchaseOrderInfo = "/shop.app.v1.OrderInfoService/RepurchaseOrderInfo"
...
func RegisterOrderInfoServiceHTTPServer(s *http.Server, srv OrderInfoServiceHTTPServer) {
	r := s.Route("/")
	r.Handle("POST", "/api/v1/app/order/confirm", _OrderInfoService_ConfirmOrderInfo0_HTTP_Handler(srv))
	r.Handle("POST", "/api/v1/app/order/confirm/buy-now", _OrderInfoService_BuyNowOrderInfo0_HTTP_Handler(srv))
	r.Handle("POST", "/api/v1/app/order/confirm/repurchase", _OrderInfoService_RepurchaseOrderInfo0_HTTP_Handler(srv))
	r.Handle("GET", "/api/v1/app/order/info/count", _OrderInfoService_CountOrderInfo0_HTTP_Handler(srv))
...
func (c *OrderInfoServiceHTTPClientImpl) BuyNowOrderInfo(ctx context.Context, in *BuyNowOrderInfoRequest, opts ...http.CallOption) (*BuyNowOrderInfoResponse, error) {
	...
	opts = append([]http.CallOption{
		...
		http.Operation(OperationOrderInfoServiceBuyNowOrderInfo),
...
func (c *OrderInfoServiceHTTPClientImpl) CancelOrderInfo(ctx context.Context, in *CancelOrderInfoRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationOrderInfoServiceCancelOrderInfo),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *OrderInfoServiceHTTPClientImpl) ConfirmOrderInfo(ctx context.Context, in *ConfirmOrderInfoRequest, opts ...http.CallOption) (*ConfirmOrderInfoResponse, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationOrderInfoServiceConfirmOrderInfo),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
...
func (c *OrderInfoServiceHTTPClientImpl) CountOrderInfo(ctx context.Context, in *CountOrderInfoRequest, opts ...http.CallOption) (*CountOrderInfoResponse, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationOrderInfoServiceCountOrderInfo),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *OrderInfoServiceHTTPClientImpl) CreateOrderInfo(ctx context.Context, in *CreateOrderInfoRequest, opts ...http.CallOption) (*CreateOrderInfoResponse, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationOrderInfoServiceCreateOrderInfo),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
...
func (c *OrderInfoServiceHTTPClientImpl) DeleteOrderInfo(ctx context.Context, in *DeleteOrderInfoRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationOrderInfoServiceDeleteOrderInfo),
		http.PathTemplate(pattern),
	}, opts...)
...
func (c *OrderInfoServiceHTTPClientImpl) GetOrderInfoById(ctx context.Context, in *GetOrderInfoByIdRequest, opts ...http.CallOption) (*OrderInfoResponse, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.Operation(OperationOrderInfoServiceGetOrderInfoById),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
...
func (c *OrderInfoServiceHTTPClientImpl) ReceiveOrderInfo(ctx context.Context, in *ReceiveOrderInfoRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationOrderInfoServiceReceiveOrderInfo),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
...
func (c *OrderInfoServiceHTTPClientImpl) RefundOrderInfo(ctx context.Context, in *RefundOrderInfoRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationOrderInfoServiceRefundOrderInfo),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
...
func (c *OrderInfoServiceHTTPClientImpl) RepurchaseOrderInfo(ctx context.Context, in *RepurchaseOrderInfoRequest, opts ...http.CallOption) (*RepurchaseOrderInfoResponse, error) {
	...
	opts = append([]http.CallOption{
		http.Accept("application/protojson"),
		http.ContentType("application/protojson"),
		http.Operation(OperationOrderInfoServiceRepurchaseOrderInfo),
		http.PathTemplate(pattern),
	}, opts...)
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
