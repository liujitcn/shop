...
type CommentFilterItem struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FilterType    v1.CommentFilterType   `protobuf:"varint,1,opt,name=filter_type,json=filterType,proto3,enum=shop.common.v1.CommentFilterType" json:"filter_type,omitempty"` // 筛选类型
...
type CommentItem struct {
	...
	Status            v1.CommentStatus       `protobuf:"varint,15,opt,name=status,proto3,enum=shop.common.v1.CommentStatus" json:"status,omitempty"`                                       // 评价审核状态：枚举【CommentStatus】
	...
	ReactionType      v1.CommentReactionType `protobuf:"varint,18,opt,name=reaction_type,json=reactionType,proto3,enum=shop.common.v1.CommentReactionType" json:"reaction_type,omitempty"` // 当前用户互动类型：枚举【CommentReactionType】
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type CommentSummary struct {
	...
	ReactionType  v1.CommentReactionType          `protobuf:"varint,5,opt,name=reaction_type,json=reactionType,proto3,enum=shop.common.v1.CommentReactionType" json:"reaction_type,omitempty"` // 当前用户互动类型：枚举【CommentReactionType】
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CommentDiscussionItem struct {
	...
	ReactionType        v1.CommentReactionType `protobuf:"varint,8,opt,name=reaction_type,json=reactionType,proto3,enum=shop.common.v1.CommentReactionType" json:"reaction_type,omitempty"` // 当前用户互动类型：枚举【CommentReactionType】
...
const file_shop_app_v1_comment_proto_rawDesc = "" +
	...
	"\tanonymous\x18\x04 \x01(\bB\x18\xbaG\x15\x92\x02\x12是否匿名展示R\tanonymous\"\x91\x02\n" +
	"\x11CommentFilterItem\x12V\n" +
	"\vfilter_type\x18\x01 \x01(\x0e2!.shop.common.v1.CommentFilterTypeB\x12\xbaG\x0f\x92\x02\f筛选类型R\n" +
	"filterType\x12G\n" +
	...
	"\rmention_count\x18\x03 \x01(\x05B\x12\xbaG\x0f\x92\x02\f提及次数R\fmentionCount\"\xae\t\n" +
	...
	"\bsku_desc\x18\x06 \x01(\tB\x18\xbaG\x15\x92\x02\x12规格展示文案R\askuDesc\x12P\n" +
	"\x04user\x18\a \x01(\v2\x1c.shop.app.v1.CommentUserViewB\x1e\xbaG\x1b\x92\x02\x18评价用户展示信息R\x04user\x125\n" +
	"\tdate_text\x18\b \x01(\tB\x18\xbaG\x15\x92\x02\x12前端展示日期R\bdateText\x12d\n" +
	"\x10content_segments\x18\t \x03(\v2\x1f.shop.app.v1.CommentTextSegmentB\x18\xbaG\x15\x92\x02\x12评价正文片段R\x0fcontentSegments\x12*\n" +
	"\x03img\x18\n" +
	...
	"goodsScore\x12k\n" +
	"\x06status\x18\x0f \x01(\x0e2\x1d.shop.common.v1.CommentStatusB4\xbaG1\x92\x02.评价审核状态：枚举【CommentStatus】R\x06status\x12.\n" +
	"\n" +
	"like_count\x18\x10 \x01(\x05B\x0f\xbaG\f\x92\x02\t点赞数R\tlikeCount\x124\n" +
	"\rdislike_count\x18\x11 \x01(\x05B\x0f\xbaG\f\x92\x02\t点踩数R\fdislikeCount\x12\x8a\x01\n" +
	"\rreaction_type\x18\x12 \x01(\x0e2#.shop.common.v1.CommentReactionTypeB@\xbaG=\x92\x02:当前用户互动类型：枚举【CommentReactionType】R\freactionType\"\x8e\x03\n" +
	"\x0eCommentSummary\x12$\n" +
	"\x02id\x18\x01 \x01(\x03B\x14\xbaG\x11\x92\x02\x0e评价摘要IDR\x02id\x12c\n" +
	"\acontent\x18\x02 \x03(\v2).shop.common.v1.CommentSummaryContentItemB\x1e\xbaG\x1b\x92\x02\x18评价摘要内容列表R\acontent\x12.\n" +
	"\n" +
	"like_count\x18\x03 \x01(\x05B\x0f\xbaG\f\x92\x02\t点赞数R\tlikeCount\x124\n" +
	"\rdislike_count\x18\x04 \x01(\x05B\x0f\xbaG\f\x92\x02\t点踩数R\fdislikeCount\x12\x8a\x01\n" +
	"\rreaction_type\x18\x05 \x01(\x0e2#.shop.common.v1.CommentReactionTypeB@\xbaG=\x92\x02:当前用户互动类型：枚举【CommentReactionType】R\freactionType\"\xd5\x05\n" +
	"\x15CommentDiscussionItem\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\x03B\x0e\xbaG\v\x92\x02\b讨论IDR\x02id\x12-\n" +
	"\n" +
	"comment_id\x18\x02 \x01(\x03B\x0e\xbaG\v\x92\x02\b评价IDR\tcommentId\x12P\n" +
	"\x04user\x18\x03 \x01(\v2\x1c.shop.app.v1.CommentUserViewB\x1e\xbaG\x1b\x92\x02\x18讨论用户展示信息R\x04user\x12,\n" +
	...
	"\n" +
	"like_count\x18\a \x01(\x05B\x0f\xbaG\f\x92\x02\t点赞数R\tlikeCount\x12\x8a\x01\n" +
	"\rreaction_type\x18\b \x01(\x0e2#.shop.common.v1.CommentReactionTypeB@\xbaG=\x92\x02:当前用户互动类型：枚举【CommentReactionType】R\freactionType\x12I\n" +
...
var (
	file_shop_app_v1_comment_proto_rawDescOnce sync.Once
	file_shop_app_v1_comment_proto_rawDescData []byte
)

func file_shop_app_v1_comment_proto_rawDescGZIP() []byte {
	file_shop_app_v1_comment_proto_rawDescOnce.Do(func() {
		file_shop_app_v1_comment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shop_app_v1_comment_proto_rawDesc), len(file_shop_app_v1_comment_proto_rawDesc)))
	})
	return file_shop_app_v1_comment_proto_rawDescData
}
...
func init() { file_shop_app_v1_comment_proto_init() }
func file_shop_app_v1_comment_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shop_app_v1_comment_proto_rawDesc), len(file_shop_app_v1_comment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   27,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_shop_app_v1_comment_proto_goTypes,
		DependencyIndexes: file_shop_app_v1_comment_proto_depIdxs,
		MessageInfos:      file_shop_app_v1_comment_proto_msgTypes,
	}.Build()
	File_shop_app_v1_comment_proto = out.File
	file_shop_app_v1_comment_proto_goTypes = nil
	file_shop_app_v1_comment_proto_depIdxs = nil
}
