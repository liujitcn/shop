...
type TenantStoreCase struct {
	...
	*data.TenantStoreRepository
	...
	formMapper     *mapper.CopierMapper[adminv1.TenantStoreForm, models.TenantStore]
	mapper         *mapper.CopierMapper[adminv1.TenantStore, models.TenantStore]
}

// NewTenantStoreCase 创建租户门店业务实例。
func NewTenantStoreCase(baseCase *biz.BaseCase, tx data.Transaction, tenantStoreRepo *data.TenantStoreRepository, goodsInfoRepo *data.GoodsInfoRepository, baseTenantCase *BaseTenantCase) *TenantStoreCase {
	formMapper := mapper.NewCopierMapper[adminv1.TenantStoreForm, models.TenantStore]()
	formMapper.AppendConverters(mapper.NewJSONTypeConverter[[]string]().NewConverterPair())
	tenantStoreMapper := mapper.NewCopierMapper[adminv1.TenantStore, models.TenantStore]()
...
func (c *TenantStoreCase) PageTenantStore(ctx context.Context, req *adminv1.PageTenantStoreRequest) (*adminv1.PageTenantStoreResponse, error) {
	...
	resList := make([]*adminv1.TenantStore, 0, len(list))
	for _, item := range list {
...
func (c *TenantStoreCase) GetTenantStore(ctx context.Context, id int64) (*adminv1.TenantStoreForm, error) {
...
func (c *TenantStoreCase) CreateTenantStore(ctx context.Context, req *adminv1.TenantStoreForm) error {
...
func (c *TenantStoreCase) UpdateTenantStore(ctx context.Context, req *adminv1.TenantStoreForm) error {
...
func (c *TenantStoreCase) AuditTenantStore(ctx context.Context, req *adminv1.AuditTenantStoreRequest) error {
	authInfo, err := c.GetAuthInfo(ctx)
	if err != nil {
		return err
	}
