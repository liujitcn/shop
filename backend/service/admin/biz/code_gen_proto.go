...
func (c *CodeGenProtoCase) SaveCodeGenProto(ctx context.Context, req *adminv1.SaveCodeGenProtoRequest) error {
	...
	expectedByKey := make(map[string]*adminv1.CodeGenProtoCheck, len(checks.GetCodeGenProtos()))
...
func (c *CodeGenProtoCase) validateCodeGenProtoColumns(ctx context.Context, tableName string, proto *adminv1.CodeGenProto, columnNamesByTable map[string]map[string]struct{}) error {
