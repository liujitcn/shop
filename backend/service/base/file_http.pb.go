...
const OperationFileServiceDownloadFile = "/base.FileService/DownloadFile"
const OperationFileServiceMultiUploadFile = "/base.FileService/MultiUploadFile"
const OperationFileServiceUploadFile = "/base.FileService/UploadFile"

type FileServiceHTTPServer interface {
	// DownloadFile 下载文件
	DownloadFile(context.Context, *base.DownloadFileRequest) (*wrapperspb.BytesValue, error)
	// MultiUploadFile 多个文件上传
	MultiUploadFile(context.Context, *base.MultiUploadFileRequest) (*base.MultiUploadFileResponse, error)
	// UploadFile 单个文件上传
	UploadFile(context.Context, *base.UploadFileInfo) (*base.FileInfo, error)
}
...
func _FileService_MultiUploadFile0_HTTP_Handler(srv FileServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in base.MultiUploadFileRequest
		r := ctx.Request()
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.MultiUploadFile(ctx, req.(*base.MultiUploadFileRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*base.MultiUploadFileResponse)
...
func _FileService_UploadFile0_HTTP_Handler(srv FileServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.UploadFile(ctx, req.(*base.UploadFileInfo))
		})
		var out interface{}
		out, err = h(ctx, in)
		if err != nil {
...
func _FileService_DownloadFile0_HTTP_Handler(srv FileServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in base.DownloadFileRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationFileServiceDownloadFile)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.DownloadFile(ctx, req.(*base.DownloadFileRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
