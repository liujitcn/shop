...
func orderStatusLabel(value any) string {
	switch int64Value(value) {
	case int64(shopcommonv1.OrderInfoStatus_NOT_STARTED_OIS):
		return "未进入履约"
	case int64(shopcommonv1.OrderInfoStatus_WAIT_SHIPMENT_OIS):
		return "待发货"
	case int64(shopcommonv1.OrderInfoStatus_SHIPPED_OIS):
		return "已发货"
	case int64(shopcommonv1.OrderInfoStatus_WAIT_REVIEW_OIS):
		return "待评价"
	case int64(shopcommonv1.OrderInfoStatus_COMPLETED_OIS):
		return "已完成"
	case int64(shopcommonv1.OrderInfoStatus_CANCELED_OIS):
		return "已取消"
	default:
		return "未知"
	}
...
func orderTradeStatusLabel(value any) string {
	switch int64Value(value) {
	case int64(shopcommonv1.OrderTradeStatus_PENDING_PAYMENT_OTS):
		return "待支付"
	case int64(shopcommonv1.OrderTradeStatus_PAYING_OTS):
		return "支付中"
	case int64(shopcommonv1.OrderTradeStatus_PAID_OTS):
		return "已支付"
	case int64(shopcommonv1.OrderTradeStatus_CASH_ON_DELIVERY_OTS):
		return "货到付款"
	case int64(shopcommonv1.OrderTradeStatus_CLOSED_OTS):
		return "已关闭"
	case int64(shopcommonv1.OrderTradeStatus_PARTIAL_REFUND_OTS):
		return "部分退款"
	case int64(shopcommonv1.OrderTradeStatus_FULL_REFUND_OTS):
		return "全额退款"
	default:
		return "未知"
	}
...
func orderRefundStatusLabel(value any) string {
	switch int64Value(value) {
	case int64(shopcommonv1.OrderRefundStatus_NONE_ORS):
		return "无退款"
	case int64(shopcommonv1.OrderRefundStatus_PROCESSING_ORS):
		return "处理中"
	case int64(shopcommonv1.OrderRefundStatus_PARTIAL_REFUND_ORS):
		return "部分退款"
	case int64(shopcommonv1.OrderRefundStatus_REFUNDED_ORS):
		return "已退款"
	case int64(shopcommonv1.OrderRefundStatus_CLOSED_OR_FAILED_ORS):
		return "已关闭/失败"
	default:
		return "未知"
	}
...
func canShipAdminOrder(order map[string]any) bool {
	...
	return status == int64(shopcommonv1.OrderInfoStatus_WAIT_SHIPMENT_OIS) &&
		(tradeStatus == int64(shopcommonv1.OrderTradeStatus_PAID_OTS) ||
			tradeStatus == int64(shopcommonv1.OrderTradeStatus_CASH_ON_DELIVERY_OTS) ||
			tradeStatus == int64(shopcommonv1.OrderTradeStatus_PARTIAL_REFUND_OTS)) &&
		(refundStatus == int64(shopcommonv1.OrderRefundStatus_NONE_ORS) ||
			refundStatus == int64(shopcommonv1.OrderRefundStatus_PARTIAL_REFUND_ORS) ||
			refundStatus == int64(shopcommonv1.OrderRefundStatus_CLOSED_OR_FAILED_ORS))
}

// commentStatusLabel 将评价审核状态枚举转换为展示文本。
func commentStatusLabel(value any) string {
	switch int64Value(value) {
	case int64(shopcommonv1.CommentStatus_PENDING_REVIEW_CS):
		return "待审核"
	case int64(shopcommonv1.CommentStatus_APPROVED_CS):
		return "审核通过"
	case int64(shopcommonv1.CommentStatus_REJECTED_CS):
		return "审核不通过"
	default:
		return "未知"
	}
...
func goodsStatusLabel(value any) string {
	switch int64Value(value) {
	case int64(shopcommonv1.GoodsStatus_PUT_ON):
		return "已上架"
	case int64(shopcommonv1.GoodsStatus_PULL_OFF):
		return "已下架"
	default:
		return "未知"
	}
...
func inventoryAlertLabel(value any) string {
	switch int64Value(value) {
	case int64(shopcommonv1.GoodsInventoryAlert_LOW_STOCK):
		return "低库存"
	case int64(shopcommonv1.GoodsInventoryAlert_ZERO_STOCK):
		return "零库存"
	default:
		return "正常"
	}
...
func payBillStatusLabel(value any) string {
	switch int64Value(value) {
	case int64(shopcommonv1.PayBillStatus_NO_COMPARE):
		return "未比对"
	case int64(shopcommonv1.PayBillStatus_NO_ERROR):
		return "无误差"
	case int64(shopcommonv1.PayBillStatus_HAS_ERROR):
		return "有误差"
	default:
		return "未知"
	}
