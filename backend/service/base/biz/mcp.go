...
// NewMcpCase 创建 MCP 业务实例，并从 base_api 表加载接口工具。
...
func (h *McpCase) filterTools(ctx context.Context, tools []mcp.Tool) []mcp.Tool {
	if len(tools) == 0 {
		return nil
	}
...
func (h *McpCase) buildToolResult(ctx context.Context, baseAPI *models.BaseAPI, mappings []mcpArgMappingItem, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var err error
...
func (h *McpCase) buildToolDefinition(baseAPI *models.BaseAPI, toolNames map[string]int, openAPISchemas map[string]any) (string, string, string) {
...
func (h *McpCase) normalizeHTTPEndpoint(addr string) string {
...
func (h *McpCase) newHTTPClient(timeout time.Duration) *http.Client {
	if timeout <= 0 {
...
func (h *McpCase) ensureBaseAPIEnabled(ctx context.Context, baseAPI *models.BaseAPI) error {
...
func (h *McpCase) buildHTTPRequest(ctx context.Context, baseAPI *models.BaseAPI, sourceHeader http.Header, mappings []mcpArgMappingItem, args map[string]any) (*http.Request, error) {
...
func (h *McpCase) valueToString(value any) string {
	switch typedValue := value.(type) {
	case string:
		return typedValue
	case fmt.Stringer:
...
func (h *McpCase) parseJSONValue(value string) any {
...
func (h *McpCase) loadOpenAPISchemas() map[string]any {
...
func (h *McpCase) normalizeInputSchema(inputSchema string, openAPISchemas map[string]any) string {
...
func (h *McpCase) expandSchemaRefs(value any, openAPISchemas map[string]any, refStack map[string]bool, depth int) any {
...
func (h *McpCase) normalizeSchemaMap(value map[string]any) map[string]any {
...
func (h *McpCase) normalizeSchemaValue(value any) any {
	switch typedValue := value.(type) {
	case map[string]any:
...
func (h *McpCase) stringMapValue(value any) (map[string]any, bool) {
	switch typedValue := value.(type) {
	case map[string]any:
