...
type UserAddressService struct {
	shopappv1.UnimplementedUserAddressServiceServer
...
func (s *UserAddressService) ListUserAddress(ctx context.Context, req *shopappv1.ListUserAddressRequest) (*shopappv1.ListUserAddressResponse, error) {
...
func (s *UserAddressService) GetUserAddress(ctx context.Context, req *shopappv1.GetUserAddressRequest) (*shopappv1.UserAddressForm, error) {
...
func (s *UserAddressService) CreateUserAddress(ctx context.Context, req *shopappv1.CreateUserAddressRequest) (*emptypb.Empty, error) {
	userAddress := req.GetUserAddress()
	// 请求体未携带地址时，使用空表单交由业务层按原有校验处理。
	if userAddress == nil {
		userAddress = &shopappv1.UserAddressForm{}
	}
...
func (s *UserAddressService) UpdateUserAddress(ctx context.Context, req *shopappv1.UpdateUserAddressRequest) (*emptypb.Empty, error) {
	userAddress := req.GetUserAddress()
	// 请求体未携带地址时，使用空表单交由业务层按原有校验处理。
	if userAddress == nil {
		userAddress = &shopappv1.UserAddressForm{}
...
func (s *UserAddressService) DeleteUserAddress(ctx context.Context, req *shopappv1.DeleteUserAddressRequest) (*emptypb.Empty, error) {
