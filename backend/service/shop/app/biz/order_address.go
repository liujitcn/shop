...
type OrderAddressCase struct {
	...
	*data.OrderAddressRepository
	...
	mapper          *mapper.CopierMapper[shopappv1.OrderInfoResponse_Address, models.OrderAddress]
}
...
func NewOrderAddressCase(baseCase *biz.BaseCase, orderAddressRepo *data.OrderAddressRepository,
	...
	return &OrderAddressCase{
		...
		mapper: func() *mapper.CopierMapper[shopappv1.OrderInfoResponse_Address, models.OrderAddress] {
			m := mapper.NewCopierMapper[shopappv1.OrderInfoResponse_Address, models.OrderAddress]()
...
func (c *OrderAddressCase) findByTradeID(ctx context.Context, tradeID int64) (*shopappv1.OrderInfoResponse_Address, error) {
