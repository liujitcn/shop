...
type UserCollectCase struct {
	...
	*data.UserCollectRepository
	...
	mapper          *mapper.CopierMapper[shopappv1.UserCollect, models.UserCollect]
	goodsMapper     *mapper.CopierMapper[shopappv1.UserCollect, models.GoodsInfo]
}
...
func NewUserCollectCase(
	...
	return &UserCollectCase{
		...
		goodsSKUCase:          goodsSKUCase,
		tenantStoreCase:       tenantStoreCase,
		mapper:                mapper.NewCopierMapper[shopappv1.UserCollect, models.UserCollect](),
		goodsMapper:           mapper.NewCopierMapper[shopappv1.UserCollect, models.GoodsInfo](),
	}
}

// PageUserCollect 查询用户收藏列表
func (c *UserCollectCase) PageUserCollect(ctx context.Context, req *shopappv1.PageUserCollectRequest) (*shopappv1.PageUserCollectResponse, error) {
	...
	list := make([]*shopappv1.UserCollect, 0)
	for _, item := range page {
		...
		if tenantStore != nil {
			collect.TenantStore = &shopappv1.TenantStore{
				Id:   tenantStore.ID,
	...
	return &shopappv1.PageUserCollectResponse{
		UserCollects: list,
		Total:        int32(count),
	}, nil
}
...
func (c *UserCollectCase) GetIsCollect(ctx context.Context, req *shopappv1.GetIsCollectRequest) (bool, error) {
	authInfo, err := c.GetAuthInfo(ctx)
	if err != nil {
		return false, err
	}
...
func (c *UserCollectCase) dispatchRecommendCollectEvent(userID, goodsID int64, recommendContext *shopappv1.RecommendContext) {
	...
	queue.DispatchRecommendEvent(&dto.RecommendActor{
		...
		EventType: shopcommonv1.RecommendEventType(_const.RECOMMEND_EVENT_TYPE_COLLECT),
