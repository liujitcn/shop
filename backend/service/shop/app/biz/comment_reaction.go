...
type CommentReactionCase struct {
	...
	*data.CommentReactionRepository
	...
	reactionMapper        *mapper.CopierMapper[shopappv1.SaveCommentReactionRequest, models.CommentReaction]
}
...
func NewCommentReactionCase(
	...
	return &CommentReactionCase{
		...
		reactionMapper:            mapper.NewCopierMapper[shopappv1.SaveCommentReactionRequest, models.CommentReaction](),
	}
}
...
func (c *CommentReactionCase) SaveCommentReaction(
	ctx context.Context,
	userID int64,
	req *shopappv1.SaveCommentReactionRequest,
) (*shopappv1.SaveCommentReactionResponse, error) {
	...
	response := &shopappv1.SaveCommentReactionResponse{
	...
	if hasCurrentReaction {
		response.ReactionType = shopcommonv1.CommentReactionType(currentReactionType)
	}
	return response, nil
}
