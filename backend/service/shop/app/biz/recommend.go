...
func (c *RecommendCase) RecommendAnonymousActor(ctx context.Context, _ *shopappv1.RecommendAnonymousActorRequest) (*shopappv1.RecommendAnonymousActorResponse, error) {
	...
	if anonymousID > 0 {
		return &shopappv1.RecommendAnonymousActorResponse{
...
func (c *RecommendCase) BindRecommendAnonymousActor(ctx context.Context, _ *shopappv1.BindRecommendAnonymousActorRequest) error {
...
func (c *RecommendCase) RecommendGoods(ctx context.Context, req *shopappv1.RecommendGoodsRequest) (*shopappv1.RecommendGoodsResponse, error) {
	...
	var goodsList []*shopappv1.GoodsInfo
	...
	return &shopappv1.RecommendGoodsResponse{
...
func (c *RecommendCase) RecommendEventReport(ctx context.Context, req *shopappv1.RecommendEventReportRequest) error {
	actor, err := c.resolveRecommendActor(ctx, true)
	if err != nil {
		return err
	}
...
func (c *RecommendCase) bindRecommendAnonymousActor(ctx context.Context, userID, anonymousID int64) error {
	...
	anonymousEventList, err := c.listRecommendEventsByActor(ctx, shopcommonv1.RecommendActorType(_const.RECOMMEND_ACTOR_TYPE_ANONYMOUS), anonymousID)
	if err != nil {
		return err
	}
...
func (c *RecommendCase) listRecommendEventsByActor(
	ctx context.Context,
	actorType shopcommonv1.RecommendActorType,
	actorID int64,
...
func (c *RecommendCase) listRecommendContextGoodsIDs(
	...
	switch req.Scene {
	case shopcommonv1.RecommendScene(_const.RECOMMEND_SCENE_GOODS_DETAIL):
		// 商品详情场景优先以当前商品作为锚点。
		if req.GoodsID > 0 {
			// 当前商品存在时，直接把商品详情页锚点作为上下文商品。
			goodsIDs = append(goodsIDs, req.GoodsID)
		}
	case shopcommonv1.RecommendScene(_const.RECOMMEND_SCENE_CART):
	...
	case shopcommonv1.RecommendScene(_const.RECOMMEND_SCENE_PROFILE):
		// 个人中心优先读取收藏商品做兴趣上下文。
		if actor != nil && actor.IsUser() {
	...
	case shopcommonv1.RecommendScene(_const.RECOMMEND_SCENE_ORDER_DETAIL), shopcommonv1.RecommendScene(_const.RECOMMEND_SCENE_ORDER_PAID):
