...
type OrderLogisticsCase struct {
	...
	*data.OrderLogisticsRepository
	mapper *mapper.CopierMapper[shopappv1.OrderInfoResponse_Logistics, models.OrderLogistics]
}
...
func NewOrderLogisticsCase(baseCase *biz.BaseCase, orderLogisticsRepo *data.OrderLogisticsRepository,
	...
	return &OrderLogisticsCase{
		...
		mapper:                   mapper.NewCopierMapper[shopappv1.OrderInfoResponse_Logistics, models.OrderLogistics](),
	}
}

// findByOrderID 按订单编号查询物流信息
func (c *OrderLogisticsCase) findByOrderID(ctx context.Context, orderID int64) (*shopappv1.OrderInfoResponse_Logistics, error) {
	...
	detail := make([]*shopappv1.OrderInfoResponse_Logistics_Detail, 0)
