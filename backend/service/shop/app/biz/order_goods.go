...
type OrderGoodsCase struct {
	...
	*data.OrderGoodsRepository
	...
	mapper        *mapper.CopierMapper[shopappv1.OrderGoods, models.OrderGoods]
}
...
func NewOrderGoodsCase(baseCase *biz.BaseCase, orderGoodsRepo *data.OrderGoodsRepository,
	...
	orderGoodsMapper := mapper.NewCopierMapper[shopappv1.OrderGoods, models.OrderGoods]()
...
func (c *OrderGoodsCase) toOrderGoods(item *models.OrderGoods) *shopappv1.OrderGoods {
	orderGoods := c.mapper.ToDTO(item)
	orderGoods.RecommendContext = &shopappv1.RecommendContext{
