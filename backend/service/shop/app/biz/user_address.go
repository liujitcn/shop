...
type UserAddressCase struct {
	...
	*data.UserAddressRepository
	...
	formMapper   *mapper.CopierMapper[shopappv1.UserAddressForm, models.UserAddress]
	mapper       *mapper.CopierMapper[shopappv1.UserAddress, models.UserAddress]
}
...
func NewUserAddressCase(baseCase *biz.BaseCase, tx data.Transaction,
	...
	formMapper := mapper.NewCopierMapper[shopappv1.UserAddressForm, models.UserAddress]()
	...
	return &UserAddressCase{
		...
		mapper:                mapper.NewCopierMapper[shopappv1.UserAddress, models.UserAddress](),
	}
}

// ListUserAddress 查询用户地址列表
func (c *UserAddressCase) ListUserAddress(ctx context.Context) (*shopappv1.ListUserAddressResponse, error) {
	...
	list := make([]*shopappv1.UserAddress, 0)
	...
	return &shopappv1.ListUserAddressResponse{
		UserAddresses: list,
	}, nil
}

// GetUserAddress 查询用户地址
func (c *UserAddressCase) GetUserAddress(ctx context.Context, id int64) (*shopappv1.UserAddressForm, error) {
	authInfo, err := c.GetAuthInfo(ctx)
	if err != nil {
		return nil, err
	}
...
// 将用户地址表单转换为模型
func (c *UserAddressCase) convertToModel(userID int64, item *shopappv1.UserAddressForm) *models.UserAddress {
