...
type GoodsInfoService struct {
	shopappv1.UnimplementedGoodsInfoServiceServer
...
func (s *GoodsInfoService) PageGoodsInfo(ctx context.Context, req *shopappv1.PageGoodsInfoRequest) (*shopappv1.PageGoodsInfoResponse, error) {
...
// GetGoodsInfo 查询商品信息
func (s *GoodsInfoService) GetGoodsInfo(ctx context.Context, req *shopappv1.GetGoodsInfoRequest) (*shopappv1.GoodsInfoResponse, error) {
