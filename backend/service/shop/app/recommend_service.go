...
type RecommendService struct {
	shopappv1.UnimplementedRecommendServiceServer
...
func (s *RecommendService) RecommendAnonymousActor(ctx context.Context, req *shopappv1.RecommendAnonymousActorRequest) (*shopappv1.RecommendAnonymousActorResponse, error) {
...
func (s *RecommendService) BindRecommendAnonymousActor(ctx context.Context, req *shopappv1.BindRecommendAnonymousActorRequest) (*emptypb.Empty, error) {
...
func (s *RecommendService) RecommendGoods(ctx context.Context, req *shopappv1.RecommendGoodsRequest) (*shopappv1.RecommendGoodsResponse, error) {
...
func (s *RecommendService) RecommendEventReport(ctx context.Context, req *shopappv1.RecommendEventReportRequest) (*emptypb.Empty, error) {
