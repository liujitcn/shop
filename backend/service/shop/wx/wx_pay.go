...
func (c *WxPayCase) JsapiPay(req jsapi.PrepayRequest) (*shopappv1.JsapiPayResponse, error) {
	...
	return &shopappv1.JsapiPayResponse{
...
// H5Pay 创建 H5 支付预下单信息。
func (c *WxPayCase) H5Pay(req h5.PrepayRequest) (*shopappv1.H5PayResponse, error) {
	// 拼接公共参数。
	req.Appid = trans.String(c.wxPay.GetAppid())
	req.Mchid = trans.String(c.wxPay.GetMchId())
	req.NotifyUrl = trans.String(c.wxPay.GetNotifyUrl() + NOTIFY_URL)
	...
	return &shopappv1.H5PayResponse{
...
func (c *WxPayCase) QueryOrderByOutTradeNo(orderNo string) (*shopappv1.PaymentResource, error) {
	...
	paymentResource := &shopappv1.PaymentResource{
		TransactionId:  trans.StringValue(resp.TransactionId),
	...
	case shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_SUCCESS).String():
		paymentResource.TradeState = shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_SUCCESS)
	case shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_REFUND).String():
		paymentResource.TradeState = shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_REFUND)
	case shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_NOT_PAY).String():
		paymentResource.TradeState = shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_NOT_PAY)
	case shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_CLOSED).String():
		paymentResource.TradeState = shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_CLOSED)
	case shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_REVOKED).String():
		paymentResource.TradeState = shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_REVOKED)
	case shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_USER_PAYING).String():
		paymentResource.TradeState = shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_USER_PAYING)
	case shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_PAY_ERROR).String():
		paymentResource.TradeState = shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_PAY_ERROR)
	default:
		paymentResource.TradeState = shopappv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_UNSPECIFIED)
	}

	// 交易类型需要显式映射，确保返回结构与项目 proto 定义一致。
	switch trans.StringValue(resp.TradeType) {
	case shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_JSAPI).String():
		paymentResource.TradeType = shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_JSAPI)
	case shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_NATIVE).String():
		paymentResource.TradeType = shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_NATIVE)
	case shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_APP).String():
		paymentResource.TradeType = shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_APP)
	case shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_MICROPAY).String():
		paymentResource.TradeType = shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_MICROPAY)
	case shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_MWEB).String():
		paymentResource.TradeType = shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_MWEB)
	case shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_FACEPAY).String():
		paymentResource.TradeType = shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_FACEPAY)
	default:
		paymentResource.TradeType = shopappv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_UNSPECIFIED)
	}

	// 微信支付返回金额信息时，按项目内资源结构回填。
	if resp.Amount != nil {
		paymentResource.Amount = &shopappv1.PaymentResource_Amount{
	...
	if resp.Payer != nil {
		paymentResource.Payer = &shopappv1.PaymentResource_Payer{
...
func (c *WxPayCase) QueryByOutRefundNo(refundOrderNo string) (*shopappv1.RefundResource, error) {
