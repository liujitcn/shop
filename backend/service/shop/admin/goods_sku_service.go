...
type GoodsSkuService struct {
	shopadminv1.UnimplementedGoodsSkuServiceServer
...
// GetGoodsSku 查询商品SKU
func (s *GoodsSkuService) GetGoodsSku(ctx context.Context, req *shopadminv1.GetGoodsSkuRequest) (*shopadminv1.GoodsSku, error) {
...
func (s *GoodsSkuService) UpdateGoodsSku(ctx context.Context, req *shopadminv1.UpdateGoodsSkuRequest) (*emptypb.Empty, error) {
