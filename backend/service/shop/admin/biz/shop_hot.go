...
type ShopHotCase struct {
	...
	*data.ShopHotRepository
	...
	formMapper      *mapper.CopierMapper[shopadminv1.ShopHotForm, models.ShopHot]
	mapper          *mapper.CopierMapper[shopadminv1.ShopHot, models.ShopHot]
}
...
func NewShopHotCase(baseCase *biz.BaseCase, tx data.Transaction, shopHotRepo *data.ShopHotRepository, shopHotItemCase *ShopHotItemCase) *ShopHotCase {
	return &ShopHotCase{
		...
		shopHotItemCase:   shopHotItemCase,
		formMapper:        mapper.NewCopierMapper[shopadminv1.ShopHotForm, models.ShopHot](),
		mapper:            mapper.NewCopierMapper[shopadminv1.ShopHot, models.ShopHot](),
	}
}

// PageShopHot 查询热门专区列表
func (c *ShopHotCase) PageShopHot(ctx context.Context, req *shopadminv1.PageShopHotRequest) (*shopadminv1.PageShopHotResponse, error) {
	...
	resList := make([]*shopadminv1.ShopHot, 0, len(list))
	for _, item := range list {
		shopHot := c.mapper.ToDTO(item)
		resList = append(resList, shopHot)
	}
	return &shopadminv1.PageShopHotResponse{ShopHots: resList, Total: int32(total)}, nil
}

// GetShopHot 获取热门专区
func (c *ShopHotCase) GetShopHot(ctx context.Context, id int64) (*shopadminv1.ShopHotForm, error) {
...
func (c *ShopHotCase) CreateShopHot(ctx context.Context, req *shopadminv1.ShopHotForm) error {
...
func (c *ShopHotCase) UpdateShopHot(ctx context.Context, req *shopadminv1.ShopHotForm) error {
	shopHot := c.formMapper.ToEntity(req)
	shopHot.Picture = _string.ConvertStringArrayToString(req.GetPicture())
...
func (c *ShopHotCase) SetShopHotStatus(ctx context.Context, req *shopadminv1.SetShopHotStatusRequest) error {
