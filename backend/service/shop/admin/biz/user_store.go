...
type UserStoreCase struct {
	...
	*data.UserStoreRepository
	...
	baseRoleCase *systemadminbiz.BaseRoleCase
	mapper       *mapper.CopierMapper[shopadminv1.UserStore, models.UserStore]
}

// NewUserStoreCase 创建门店申请业务实例
func NewUserStoreCase(baseCase *biz.BaseCase, tx data.Transaction, userStoreRepo *data.UserStoreRepository, baseAreaRepo *data.BaseAreaRepository, baseUserCase *systemadminbiz.BaseUserCase, baseRoleCase *systemadminbiz.BaseRoleCase,
) *UserStoreCase {
	userStoreMapper := mapper.NewCopierMapper[shopadminv1.UserStore, models.UserStore]()
...
func (c *UserStoreCase) PageUserStore(ctx context.Context, req *shopadminv1.PageUserStoreRequest) (*shopadminv1.PageUserStoreResponse, error) {
	...
	list := make([]*shopadminv1.UserStore, 0, len(page))
	for _, item := range page {
	...
	return &shopadminv1.PageUserStoreResponse{
		UserStores: list,
		Total:      int32(count),
	}, nil
}
...
// GetUserStore 获取门店申请
func (c *UserStoreCase) GetUserStore(ctx context.Context, id int64) (*shopadminv1.UserStore, error) {
...
func (c *UserStoreCase) AuditUserStore(ctx context.Context, req *shopadminv1.AuditUserStoreRequest) error {
...
func (c *UserStoreCase) toUserStore(ctx context.Context, item *models.UserStore) *shopadminv1.UserStore {
