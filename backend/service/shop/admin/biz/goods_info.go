...
type GoodsInfoCase struct {
	...
	*data.GoodsInfoRepository
	...
	formMapper        *_mapper.CopierMapper[shopadminv1.GoodsInfoForm, models.GoodsInfo]
	mapper            *_mapper.CopierMapper[shopadminv1.GoodsInfo, models.GoodsInfo]
}

const (
	// GOODS_INVENTORY_ALERT_LOW 表示低库存预警。
	GOODS_INVENTORY_ALERT_LOW = shopcommonv1.GoodsInventoryAlert_LOW_STOCK
	// GOODS_INVENTORY_ALERT_ZERO 表示零库存预警。
	GOODS_INVENTORY_ALERT_ZERO = shopcommonv1.GoodsInventoryAlert_ZERO_STOCK
	// GOODS_PRICE_ALERT_ABNORMAL 表示价格配置异常预警。
	GOODS_PRICE_ALERT_ABNORMAL = shopcommonv1.GoodsPriceAlert_PRICE_CONFIG_ABNORMAL
)
...
func NewGoodsInfoCase(baseCase *biz.BaseCase, tx data.Transaction, goodsInfoRepo *data.GoodsInfoRepository, goodsCategoryCase *GoodsCategoryCase, goodsPropCase *GoodsPropCase, goodsSpecCase *GoodsSpecCase, goodsSKUCase *GoodsSKUCase, tenantStoreCase *TenantStoreCase,
	...
	formMapper := _mapper.NewCopierMapper[shopadminv1.GoodsInfoForm, models.GoodsInfo]()
	...
	mapper := _mapper.NewCopierMapper[shopadminv1.GoodsInfo, models.GoodsInfo]()
...
func (c *GoodsInfoCase) OptionGoodsInfo(ctx context.Context, req *shopadminv1.OptionGoodsInfoRequest) (*shopadminv1.OptionGoodsInfoResponse, error) {
...
func (c *GoodsInfoCase) PageGoodsInfo(ctx context.Context, req *shopadminv1.PageGoodsInfoRequest) (*shopadminv1.PageGoodsInfoResponse, error) {
	query := c.Query(ctx).GoodsInfo
	...
	if req.CategoryId != nil && req.GetCategoryId() > 0 {
		...
		if len(goodsIDList) == 0 {
			return &shopadminv1.PageGoodsInfoResponse{GoodsInfos: []*shopadminv1.GoodsInfo{}, Total: 0}, nil
		}
...
// GetGoodsInfo 获取商品
func (c *GoodsInfoCase) GetGoodsInfo(ctx context.Context, id int64) (*shopadminv1.GoodsInfoForm, error) {
	...
	var specList *shopadminv1.ListGoodsSpecResponse
	specList, err = c.goodsSpecCase.ListGoodsSpec(ctx, &shopadminv1.ListGoodsSpecRequest{GoodsId: goodsForm.Id})
	if err != nil {
		return nil, err
	}
...
func (c *GoodsInfoCase) CreateGoodsInfo(ctx context.Context, req *shopadminv1.GoodsInfoForm) error {
...
func (c *GoodsInfoCase) UpdateGoodsInfo(ctx context.Context, req *shopadminv1.GoodsInfoForm) error {
	goodsInfo := c.formMapper.ToEntity(req)
	err := c.fillGoodsTenantByStore(ctx, goodsInfo)
	if err != nil {
		return err
...
func (c *GoodsInfoCase) SetGoodsInfoStatus(ctx context.Context, req *shopadminv1.SetGoodsInfoStatusRequest) error {
...
func (c *GoodsInfoCase) GoodsPropCaseList(ctx context.Context, goodsID int64) ([]*shopadminv1.GoodsProp, error) {
...
func (c *GoodsInfoCase) batchCreateGoodsProp(ctx context.Context, goodsInfo *models.GoodsInfo, list []*shopadminv1.GoodsProp) error {
...
func (c *GoodsInfoCase) batchCreateGoodsSpec(ctx context.Context, goodsInfo *models.GoodsInfo, list []*shopadminv1.GoodsSpec) error {
...
func (c *GoodsInfoCase) batchCreateGoodsSKU(ctx context.Context, goodsInfo *models.GoodsInfo, list []*shopadminv1.GoodsSku) error {
