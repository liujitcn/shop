...
type GoodsReportCase struct {
	...
	*data.GoodsStatDayRepository
	monthMapper *mapper.CopierMapper[shopadminv1.GoodsMonthReportItem, dto.GoodsMonthReportRow]
	dayMapper   *mapper.CopierMapper[shopadminv1.GoodsDayReportItem, dto.GoodsDayReportRow]
}
...
func NewGoodsReportCase(baseCase *biz.BaseCase, goodsStatDayRepo *data.GoodsStatDayRepository) *GoodsReportCase {
	return &GoodsReportCase{
		...
		monthMapper:            mapper.NewCopierMapper[shopadminv1.GoodsMonthReportItem, dto.GoodsMonthReportRow](),
		dayMapper:              mapper.NewCopierMapper[shopadminv1.GoodsDayReportItem, dto.GoodsDayReportRow](),
	}
}
...
func (c *GoodsReportCase) ListGoodsMonthReport(ctx context.Context, req *shopadminv1.ListGoodsMonthReportRequest) (*shopadminv1.ListGoodsMonthReportResponse, error) {
	...
	items := make([]*shopadminv1.GoodsMonthReportItem, 0)
...
func (c *GoodsReportCase) SummaryGoodsDayReport(ctx context.Context, req *shopadminv1.SummaryGoodsDayReportRequest) (*shopadminv1.SummaryGoodsDayReportResponse, error) {
	...
	summary := &shopadminv1.SummaryGoodsDayReportResponse{}
	for _, row := range rows {
...
func (c *GoodsReportCase) appendMonthReportSummary(summary *shopadminv1.SummaryGoodsMonthReportResponse, item *shopadminv1.GoodsMonthReportItem) {
...
func (c *GoodsReportCase) appendDayReportSummary(summary *shopadminv1.SummaryGoodsDayReportResponse, item *shopadminv1.GoodsDayReportItem) {
	summary.ViewCount += item.ViewCount
	summary.CollectCount += item.CollectCount
	summary.CartCount += item.CartCount
	summary.OrderCount += item.OrderCount
...
func (c *GoodsReportCase) toGoodsMonthReportItem(row *dto.GoodsMonthReportRow) *shopadminv1.GoodsMonthReportItem {
...
func (c *GoodsReportCase) toGoodsDayReportItem(row *dto.GoodsDayReportRow) *shopadminv1.GoodsDayReportItem {
