...
type ShopServiceCase struct {
	...
	*data.ShopServiceRepository
	formMapper *mapper.CopierMapper[shopadminv1.ShopServiceForm, models.ShopService]
	mapper     *mapper.CopierMapper[shopadminv1.ShopService, models.ShopService]
}
...
func NewShopServiceCase(baseCase *biz.BaseCase, shopServiceRepo *data.ShopServiceRepository) *ShopServiceCase {
	return &ShopServiceCase{
		...
		formMapper:            mapper.NewCopierMapper[shopadminv1.ShopServiceForm, models.ShopService](),
		mapper:                mapper.NewCopierMapper[shopadminv1.ShopService, models.ShopService](),
	}
}

// PageShopService 查询服务保障列表
func (c *ShopServiceCase) PageShopService(ctx context.Context, req *shopadminv1.PageShopServiceRequest) (*shopadminv1.PageShopServiceResponse, error) {
	...
	resList := make([]*shopadminv1.ShopService, 0, len(list))
	for _, item := range list {
		shopService := c.mapper.ToDTO(item)
		resList = append(resList, shopService)
	}
	return &shopadminv1.PageShopServiceResponse{ShopServices: resList, Total: int32(total)}, nil
}

// GetShopService 获取服务保障
func (c *ShopServiceCase) GetShopService(ctx context.Context, id int64) (*shopadminv1.ShopServiceForm, error) {
...
func (c *ShopServiceCase) CreateShopService(ctx context.Context, req *shopadminv1.ShopServiceForm) error {
	shopService := c.formMapper.ToEntity(req)
	return c.Create(ctx, shopService)
}

// UpdateShopService 更新服务保障
func (c *ShopServiceCase) UpdateShopService(ctx context.Context, req *shopadminv1.ShopServiceForm) error {
	shopService := c.formMapper.ToEntity(req)
...
func (c *ShopServiceCase) SetShopServiceStatus(ctx context.Context, req *shopadminv1.SetShopServiceStatusRequest) error {
