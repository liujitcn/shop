...
type CommentInfoCase struct {
	...
	*data.CommentInfoRepository
	...
	commentInfoMapper     *mapper.CopierMapper[shopadminv1.CommentInfo, models.CommentInfo]
}
...
func NewCommentInfoCase(
	...
	commentInfoMapper := mapper.NewCopierMapper[shopadminv1.CommentInfo, models.CommentInfo]()
...
func (c *CommentInfoCase) PageCommentInfo(ctx context.Context, req *shopadminv1.PageCommentInfoRequest) (*shopadminv1.PageCommentInfoResponse, error) {
	...
	resList := make([]*shopadminv1.CommentInfo, 0, len(list))
...
func (c *CommentInfoCase) GetGoodsCommentInfo(ctx context.Context, goodsID int64) (*shopadminv1.GoodsCommentInfoResponse, error) {
	...
	resCommentList := make([]*shopadminv1.CommentInfo, 0, len(commentList))
	...
	return &shopadminv1.GoodsCommentInfoResponse{
