...
func NewUserAnalyticsCase(baseUserCase *systemadminbiz.BaseUserCase, orderInfoCase *OrderInfoCase) *UserAnalyticsCase {
...
func (c *UserAnalyticsCase) SummaryUserAnalytics(ctx context.Context, req *shopadminv1.SummaryUserAnalyticsRequest) (*shopadminv1.SummaryUserAnalyticsResponse, error) {
	...
	return &shopadminv1.SummaryUserAnalyticsResponse{
...
func (c *UserAnalyticsCase) TrendUserAnalytics(ctx context.Context, req *shopadminv1.TrendUserAnalyticsRequest) (*commonv1.AnalyticsTrendResponse, error) {
	startAt, endAt := utils.GetAnalyticsTimeRange(req.GetTimeType())
...
func (c *UserAnalyticsCase) RankUserAnalytics(ctx context.Context, req *shopadminv1.RankUserAnalyticsRequest) (*commonv1.AnalyticsRankResponse, error) {
