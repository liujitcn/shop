...
type ShopBannerCase struct {
	...
	*data.ShopBannerRepository
	formMapper *mapper.CopierMapper[shopadminv1.ShopBannerForm, models.ShopBanner]
	mapper     *mapper.CopierMapper[shopadminv1.ShopBanner, models.ShopBanner]
}
...
func NewShopBannerCase(baseCase *biz.BaseCase, shopBannerRepo *data.ShopBannerRepository) *ShopBannerCase {
	return &ShopBannerCase{
		...
		formMapper:           mapper.NewCopierMapper[shopadminv1.ShopBannerForm, models.ShopBanner](),
		mapper:               mapper.NewCopierMapper[shopadminv1.ShopBanner, models.ShopBanner](),
	}
}

// PageShopBanner 查询商城轮播图列表
func (c *ShopBannerCase) PageShopBanner(ctx context.Context, req *shopadminv1.PageShopBannerRequest) (*shopadminv1.PageShopBannerResponse, error) {
	...
	resList := make([]*shopadminv1.ShopBanner, 0, len(list))
	for _, item := range list {
		shopBanner := c.mapper.ToDTO(item)
		resList = append(resList, shopBanner)
	}
	return &shopadminv1.PageShopBannerResponse{ShopBanners: resList, Total: int32(total)}, nil
}

// GetShopBanner 获取商城轮播图
func (c *ShopBannerCase) GetShopBanner(ctx context.Context, id int64) (*shopadminv1.ShopBannerForm, error) {
...
func (c *ShopBannerCase) SetShopBannerStatus(ctx context.Context, req *shopadminv1.SetShopBannerStatusRequest) error {
