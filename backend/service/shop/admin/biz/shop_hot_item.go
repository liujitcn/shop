...
type ShopHotItemCase struct {
	...
	*data.ShopHotItemRepository
	...
	formMapper       *mapper.CopierMapper[shopadminv1.ShopHotItemForm, models.ShopHotItem]
	mapper           *mapper.CopierMapper[shopadminv1.ShopHotItem, models.ShopHotItem]
}
...
func NewShopHotItemCase(baseCase *biz.BaseCase, tx data.Transaction, shopHotRepo *data.ShopHotRepository, shopHotItemRepo *data.ShopHotItemRepository, shopHotGoodsRepo *data.ShopHotGoodsRepository) *ShopHotItemCase {
	return &ShopHotItemCase{
		...
		formMapper:            mapper.NewCopierMapper[shopadminv1.ShopHotItemForm, models.ShopHotItem](),
		mapper:                mapper.NewCopierMapper[shopadminv1.ShopHotItem, models.ShopHotItem](),
	}
}

// PageShopHotItem 查询热门专区项目列表
func (c *ShopHotItemCase) PageShopHotItem(ctx context.Context, req *shopadminv1.PageShopHotItemRequest) (*shopadminv1.PageShopHotItemResponse, error) {
	...
	resList := make([]*shopadminv1.ShopHotItem, 0, len(list))
	for _, item := range list {
		shopHotItem := c.mapper.ToDTO(item)
		resList = append(resList, shopHotItem)
	}
	return &shopadminv1.PageShopHotItemResponse{ShopHotItems: resList, Total: int32(total)}, nil
}

// GetShopHotItem 获取热门专区项目
func (c *ShopHotItemCase) GetShopHotItem(ctx context.Context, id int64) (*shopadminv1.ShopHotItemForm, error) {
...
func (c *ShopHotItemCase) CreateShopHotItem(ctx context.Context, req *shopadminv1.ShopHotItemForm) error {
...
func (c *ShopHotItemCase) UpdateShopHotItem(ctx context.Context, req *shopadminv1.ShopHotItemForm) error {
	return c.tx.Transaction(ctx, func(ctx context.Context) error {
		shopHotItem := c.formMapper.ToEntity(req)
...
func (c *ShopHotItemCase) SetShopHotItemStatus(ctx context.Context, req *shopadminv1.SetShopHotItemStatusRequest) error {
