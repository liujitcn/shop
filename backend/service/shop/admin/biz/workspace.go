...
func (c *WorkspaceCase) SummaryWorkspaceMetrics(ctx context.Context, req *shopadminv1.SummaryWorkspaceMetricsRequest) (*shopadminv1.SummaryWorkspaceMetricsResponse, error) {
	...
	return &shopadminv1.SummaryWorkspaceMetricsResponse{
...
func (c *WorkspaceCase) SummaryWorkspaceTodo(ctx context.Context, req *shopadminv1.SummaryWorkspaceTodoRequest) (*shopadminv1.SummaryWorkspaceTodoResponse, error) {
	useGlobalTradeScope, err := c.orderInfoCase.useGlobalOrderTradeScope(ctx, req.GetTenantId(), req.GetTenantStoreId())
	if err != nil {
		return nil, err
	}
	...
	return &shopadminv1.SummaryWorkspaceTodoResponse{
...
func (c *WorkspaceCase) SummaryWorkspaceRisk(ctx context.Context, req *shopadminv1.SummaryWorkspaceRiskRequest) (*shopadminv1.SummaryWorkspaceRiskResponse, error) {
	...
	return &shopadminv1.SummaryWorkspaceRiskResponse{
...
func (c *WorkspaceCase) SummaryWorkspaceReputation(ctx context.Context, req *shopadminv1.SummaryWorkspaceReputationRequest) (*shopadminv1.SummaryWorkspaceReputationResponse, error) {
	...
	var hotTags []*shopadminv1.WorkspaceReputationTag
	...
	return &shopadminv1.SummaryWorkspaceReputationResponse{
		AverageCommentScore: averageCommentScore,
		HotTags:             hotTags,
...
func (c *WorkspaceCase) listHotCommentTags(ctx context.Context, tenantID, tenantStoreID int64) ([]*shopadminv1.WorkspaceReputationTag, error) {
	...
	tags := make([]*shopadminv1.WorkspaceReputationTag, 0, len(list))
	for _, item := range list {
		tags = append(tags, &shopadminv1.WorkspaceReputationTag{
			Name:         item.Name,
...
func (c *WorkspaceCase) latestCommentSummary(ctx context.Context, tenantID, tenantStoreID int64) (string, error) {
	...
	var items []*shopcommonv1.CommentSummaryContentItem
