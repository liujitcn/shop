...
type UserAnalyticsService struct {
	shopadminv1.UnimplementedUserAnalyticsServiceServer
...
func (s *UserAnalyticsService) SummaryUserAnalytics(ctx context.Context, req *shopadminv1.SummaryUserAnalyticsRequest) (*shopadminv1.SummaryUserAnalyticsResponse, error) {
	res, err := s.userAnalyticsCase.SummaryUserAnalytics(ctx, req)
	if err != nil {
		log.Error(fmt.Sprintf("SummaryUserAnalytics %v", err))
...
func (s *UserAnalyticsService) TrendUserAnalytics(ctx context.Context, req *shopadminv1.TrendUserAnalyticsRequest) (*commonv1.AnalyticsTrendResponse, error) {
	res, err := s.userAnalyticsCase.TrendUserAnalytics(ctx, req)
	if err != nil {
		log.Error(fmt.Sprintf("TrendUserAnalytics %v", err))
...
func (s *UserAnalyticsService) RankUserAnalytics(ctx context.Context, req *shopadminv1.RankUserAnalyticsRequest) (*commonv1.AnalyticsRankResponse, error) {
	res, err := s.userAnalyticsCase.RankUserAnalytics(ctx, req)
	if err != nil {
		log.Error(fmt.Sprintf("RankUserAnalytics %v", err))
