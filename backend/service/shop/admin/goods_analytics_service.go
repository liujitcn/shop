...
type GoodsAnalyticsService struct {
	shopadminv1.UnimplementedGoodsAnalyticsServiceServer
...
func (s *GoodsAnalyticsService) SummaryGoodsAnalytics(ctx context.Context, req *shopadminv1.SummaryGoodsAnalyticsRequest) (*shopadminv1.SummaryGoodsAnalyticsResponse, error) {
	res, err := s.goodsAnalyticsCase.SummaryGoodsAnalytics(ctx, req)
	if err != nil {
		log.Error(fmt.Sprintf("SummaryGoodsAnalytics %v", err))
...
func (s *GoodsAnalyticsService) TrendGoodsAnalytics(ctx context.Context, req *shopadminv1.TrendGoodsAnalyticsRequest) (*commonv1.AnalyticsTrendResponse, error) {
	res, err := s.goodsAnalyticsCase.TrendGoodsAnalytics(ctx, req)
	if err != nil {
		log.Error(fmt.Sprintf("TrendGoodsAnalytics %v", err))
...
func (s *GoodsAnalyticsService) PieGoodsAnalytics(ctx context.Context, req *shopadminv1.PieGoodsAnalyticsRequest) (*commonv1.AnalyticsPieResponse, error) {
	res, err := s.goodsAnalyticsCase.PieGoodsAnalytics(ctx, req)
	if err != nil {
		log.Error(fmt.Sprintf("PieGoodsAnalytics %v", err))
...
func (s *GoodsAnalyticsService) RankGoodsAnalytics(ctx context.Context, req *shopadminv1.RankGoodsAnalyticsRequest) (*commonv1.AnalyticsRankResponse, error) {
	res, err := s.goodsAnalyticsCase.RankGoodsAnalytics(ctx, req)
	if err != nil {
		log.Error(fmt.Sprintf("RankGoodsAnalytics %v", err))
