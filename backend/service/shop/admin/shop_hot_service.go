...
type ShopHotService struct {
	shopadminv1.UnimplementedShopHotServiceServer
...
func (s *ShopHotService) PageShopHot(ctx context.Context, req *shopadminv1.PageShopHotRequest) (*shopadminv1.PageShopHotResponse, error) {
...
func (s *ShopHotService) UpdateShopHot(ctx context.Context, req *shopadminv1.UpdateShopHotRequest) (*emptypb.Empty, error) {
...
func (s *ShopHotService) DeleteShopHotItem(ctx context.Context, req *shopadminv1.DeleteShopHotItemRequest) (*emptypb.Empty, error) {
...
func (s *ShopHotService) SetShopHotItemStatus(ctx context.Context, req *shopadminv1.SetShopHotItemStatusRequest) (*emptypb.Empty, error) {
