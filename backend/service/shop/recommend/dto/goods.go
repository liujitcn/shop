...
import shopcommonv1 "shop/api/gen/go/shop/common/v1"
...
type GoodsRequest struct {
	Scene           shopcommonv1.RecommendScene // 推荐场景
...
type GoodsResult struct {
	...
	Total        int64                          // 推荐结果总数
	Strategy     shopcommonv1.RecommendStrategy // 当前命中的推荐策略
...
type RecommendContext struct {
	...
	Strategy        shopcommonv1.RecommendStrategy `json:"strategy,omitempty"`          // 当前命中的推荐策略
