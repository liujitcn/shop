...
type TenantStoreCase struct {
	...
	*data.TenantStoreRepository
	mapper *mapper.CopierMapper[appv1.TenantStore, models.TenantStore]
}
...
func NewTenantStoreCase(baseCase *biz.BaseCase, tenantStoreRepo *data.TenantStoreRepository) *TenantStoreCase {
	tenantStoreMapper := mapper.NewCopierMapper[appv1.TenantStore, models.TenantStore]()
...
func (c *TenantStoreCase) GetTenantStore(ctx context.Context, id int64) (*appv1.TenantStore, error) {
