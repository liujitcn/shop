...
type CommentSummaryCase struct {
	...
	*data.CommentSummaryRepository
	...
	commentSummaryMapper *mapper.CopierMapper[appv1.CommentSummary, models.CommentSummary]
}
...
func NewCommentSummaryCase(
	...
	commentSummaryMapper := mapper.NewCopierMapper[appv1.CommentSummary, models.CommentSummary]()
...
func (c *CommentSummaryCase) GoodsCommentOverview(ctx context.Context, goodsID, userID int64) (*appv1.CommentSummary, error) {
	return c.buildCardByGoodsIDAndScene(ctx, goodsID, _const.COMMENT_SUMMARY_SCENE_OVERVIEW, userID)
}

// PageGoodsComment 查询评价列表摘要卡片。
func (c *CommentSummaryCase) PageGoodsComment(ctx context.Context, goodsID, userID int64) (*appv1.CommentSummary, error) {
...
func (c *CommentSummaryCase) buildCardByGoodsIDAndScene(ctx context.Context, goodsID int64, scene int32, userID int64) (*appv1.CommentSummary, error) {
	query := c.Query(ctx).CommentSummary
	...
	if len(recordList) == 0 {
		return &appv1.CommentSummary{}, nil
	}
	record := recordList[0]
...
func (c *CommentSummaryCase) upsertSceneContent(ctx context.Context, tenantID, tenantStoreID, goodsID int64, scene int32, content []comment.SummaryContentItem) error {
	...
	for _, item := range content {
		...
		contentList = append(contentList, &commonv1.CommentSummaryContentItem{
			Label:   item.Label,
