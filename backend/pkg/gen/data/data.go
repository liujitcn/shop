...
func init() {
	databaseGorm.RegisterMigrateModels(
		...
		new(models.GoodsStatDay),
		new(models.OrderAddress),
		new(models.OrderCancel),
		new(models.OrderGoods),
		new(models.OrderInfo),
		new(models.OrderLogistics),
		new(models.OrderPayment),
		new(models.OrderRefund),
		new(models.OrderStatDay),
		new(models.PayBill),
		new(models.RecommendActorBindLog),
		new(models.RecommendEvalReport),
		new(models.RecommendExposure),
		new(models.RecommendExposureItem),
		new(models.RecommendGoodsAction),
		new(models.RecommendGoodsRelation),
		new(models.RecommendGoodsStatDay),
		new(models.RecommendModelVersion),
		new(models.RecommendRequest),
		new(models.RecommendRequestItem),
		new(models.RecommendUserGoodsPreference),
		new(models.RecommendUserPreference),
