...
type BaseJob struct {
	...
	DeletedAt      soft_delete.DeletedAt `gorm:"column:deleted_at;type:bigint unsigned;not null;uniqueIndex:unique_base_job,priority:2;softDelete:milli" json:"deleted_at"`
}
