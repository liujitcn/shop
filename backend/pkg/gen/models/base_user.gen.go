...
type BaseUser struct {
	...
	TenantID  int64          `gorm:"column:tenant_id;type:bigint;uniqueIndex:unique_base_user,priority:1;index:idx_base_user_tenant_id,priority:1;comment:租户ID" json:"tenant_id"` // 租户ID
