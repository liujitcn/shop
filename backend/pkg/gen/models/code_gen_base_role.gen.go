...
const TableNameCodeGenBaseRole = "code_gen_base_role"
...
type CodeGenBaseRole struct {
	...
	Code      string         `gorm:"column:code;type:varchar(100);uniqueIndex:unique_base_role,priority:2;comment:角色代码" json:"code"`                                                       // 角色代码
...
// TableName CodeGenBaseRole's table name
func (*CodeGenBaseRole) TableName() string {
	return TableNameCodeGenBaseRole
}
