...
const TableNameCodeGenBaseDept = "code_gen_base_dept"
...
// TableName CodeGenBaseDept's table name
func (*CodeGenBaseDept) TableName() string {
	return TableNameCodeGenBaseDept
}
