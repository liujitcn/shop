...
type GoodsStatDay struct {
	...
	TenantID      int64          `gorm:"column:tenant_id;type:bigint;not null;uniqueIndex:unique_goods_stat_day,priority:1;default:1;comment:租户ID" json:"tenant_id"`                                                         // 租户ID
	...
	StatDate      time.Time      `gorm:"column:stat_date;type:date;uniqueIndex:unique_goods_stat_day,priority:3;comment:统计日期" json:"stat_date"`                                                                              // 统计日期
	GoodsID       int64          `gorm:"column:goods_id;type:bigint;uniqueIndex:unique_goods_stat_day,priority:4;comment:商品ID" json:"goods_id"`                                                                              // 商品ID
