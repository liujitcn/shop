...
type GoodsStatDay struct {
	...
	StatDate     time.Time      `gorm:"column:stat_date;type:date;uniqueIndex:unique_goods_stat_day,priority:1;comment:统计日期" json:"stat_date"`         // 统计日期
	GoodsID      int64          `gorm:"column:goods_id;type:bigint;uniqueIndex:unique_goods_stat_day,priority:2;comment:商品ID" json:"goods_id"`         // 商品ID
