...
type OrderPayment struct {
	...
	Payer          string         `gorm:"column:payer;type:text;comment:支付者信息" json:"payer"`                                                                                                                                            // 支付者信息
	Amount         string         `gorm:"column:amount;type:text;comment:订单金额" json:"amount"`                                                                                                                                           // 订单金额
	SceneInfo      string         `gorm:"column:scene_info;type:text;comment:场景信息" json:"scene_info"`                                                                                                                                   // 场景信息
