...
type BaseTenant struct {
	...
	ContactName  string         `gorm:"column:contact_name;type:varchar(50);not null;comment:联系人" json:"contact_name"`                                             // 联系人
	ContactPhone string         `gorm:"column:contact_phone;type:varchar(20);not null;comment:联系电话" json:"contact_phone"`                                          // 联系电话
	Status       int32          `gorm:"column:status;type:tinyint;not null;index:idx_base_tenant_status,priority:1;default:1;comment:状态：枚举【Status】" json:"status"` // 状态：枚举【Status】
