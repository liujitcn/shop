...
type BaseRole struct {
	...
	TenantID  int64          `gorm:"column:tenant_id;type:bigint;uniqueIndex:unique_base_role,priority:1;index:idx_base_role_tenant_id,priority:1;comment:租户ID" json:"tenant_id"` // 租户ID
