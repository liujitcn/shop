...
type BaseRole struct {
	...
	DeletedAt soft_delete.DeletedAt `gorm:"column:deleted_at;type:bigint unsigned;not null;uniqueIndex:unique_base_role,priority:3;softDelete:milli" json:"deleted_at"`
}
