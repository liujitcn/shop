...
const TableNameCodeGenBaseUser = "code_gen_base_user"
...
// TableName CodeGenBaseUser's table name
func (*CodeGenBaseUser) TableName() string {
	return TableNameCodeGenBaseUser
}
