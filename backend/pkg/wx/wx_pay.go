...
func NewWxPayCase(baseCase *biz.BaseCase, wxPay *configv1.WxPay) (*WxPayCase, error) {
...
func (c *WxPayCase) JsapiPay(req jsapi.PrepayRequest) (*appv1.JsapiPayResponse, error) {
	// 拼接公共参数。
	req.Appid = trans.String(c.wxPay.GetAppid())
	req.Mchid = trans.String(c.wxPay.GetMchId())
	req.NotifyUrl = trans.String(c.wxPay.GetNotifyUrl() + NOTIFY_URL)
...
// H5Pay 创建 H5 支付预下单信息。
func (c *WxPayCase) H5Pay(req h5.PrepayRequest) (*appv1.H5PayResponse, error) {
	// 拼接公共参数。
	req.Appid = trans.String(c.wxPay.GetAppid())
	req.Mchid = trans.String(c.wxPay.GetMchId())
	req.NotifyUrl = trans.String(c.wxPay.GetNotifyUrl() + NOTIFY_URL)
...
func (c *WxPayCase) QueryOrderByOutTradeNo(orderNo string) (*appv1.PaymentResource, error) {
	...
	paymentResource := &appv1.PaymentResource{
	...
	case appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_SUCCESS).String():
		paymentResource.TradeState = appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_SUCCESS)
	case appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_REFUND).String():
		paymentResource.TradeState = appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_REFUND)
	case appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_NOT_PAY).String():
		paymentResource.TradeState = appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_NOT_PAY)
	case appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_CLOSED).String():
		paymentResource.TradeState = appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_CLOSED)
	case appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_REVOKED).String():
		paymentResource.TradeState = appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_REVOKED)
	case appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_USER_PAYING).String():
		paymentResource.TradeState = appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_USER_PAYING)
	case appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_PAY_ERROR).String():
		paymentResource.TradeState = appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_PAY_ERROR)
	default:
		paymentResource.TradeState = appv1.PaymentResource_TradeState(_const.PAYMENT_RESOURCE_TRADE_STATE_UNSPECIFIED)
	}

	// 交易类型需要显式映射，确保返回结构与项目 proto 定义一致。
	switch trans.StringValue(resp.TradeType) {
	case appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_JSAPI).String():
		paymentResource.TradeType = appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_JSAPI)
	case appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_NATIVE).String():
		paymentResource.TradeType = appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_NATIVE)
	case appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_APP).String():
		paymentResource.TradeType = appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_APP)
	case appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_MICROPAY).String():
		paymentResource.TradeType = appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_MICROPAY)
	case appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_MWEB).String():
		paymentResource.TradeType = appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_MWEB)
	case appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_FACEPAY).String():
		paymentResource.TradeType = appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_FACEPAY)
	default:
		paymentResource.TradeType = appv1.PaymentResource_TradeType(_const.PAYMENT_RESOURCE_TRADE_TYPE_UNSPECIFIED)
	}

	// 微信支付返回金额信息时，按项目内资源结构回填。
	if resp.Amount != nil {
		paymentResource.Amount = &appv1.PaymentResource_Amount{
	...
	if resp.Payer != nil {
		paymentResource.Payer = &appv1.PaymentResource_Payer{
...
func (c *WxPayCase) QueryByOutRefundNo(refundOrderNo string) (*appv1.RefundResource, error) {
	...
	case appv1.RefundResource_RefundStatus(_const.REFUND_RESOURCE_STATUS_SUCCESS).String():
		refundResource.RefundStatus = appv1.RefundResource_RefundStatus(_const.REFUND_RESOURCE_STATUS_SUCCESS)
	case appv1.RefundResource_RefundStatus(_const.REFUND_RESOURCE_STATUS_CLOSED).String():
		refundResource.RefundStatus = appv1.RefundResource_RefundStatus(_const.REFUND_RESOURCE_STATUS_CLOSED)
	case appv1.RefundResource_RefundStatus(_const.REFUND_RESOURCE_STATUS_PROCESSING).String():
		refundResource.RefundStatus = appv1.RefundResource_RefundStatus(_const.REFUND_RESOURCE_STATUS_PROCESSING)
	case appv1.RefundResource_RefundStatus(_const.REFUND_RESOURCE_STATUS_ABNORMAL).String():
		refundResource.RefundStatus = appv1.RefundResource_RefundStatus(_const.REFUND_RESOURCE_STATUS_ABNORMAL)
	default:
		refundResource.RefundStatus = appv1.RefundResource_RefundStatus(_const.REFUND_RESOURCE_STATUS_UNSPECIFIED)
	}

	// 微信退款返回金额信息时，按项目内资源结构回填。
	if resp.Amount != nil {
		refundResource.Amount = &appv1.RefundResource_Amount{
